...
public class ConsolePlugin implements Destroyable, Listener, WarningView.Listener {
    ...
    static class C15651 implements OnDispatchListener {
        C15651() {
        }
    ...
    static class C15662 implements Runnable {
        ...
        C15662(Activity activity, String str, int i, int i2, ConsolePluginImp consolePluginImp) {
    ...
    static class C15673 implements Runnable {
        C15673() {
        }
    ...
    static class C15684 implements Runnable {
        C15684() {
        }
    ...
    static class C15695 implements Runnable {
        C15695() {
        }
    ...
    static class C15706 implements Runnable {
        C15706() {
        }
    ...
    class C15717 implements OnGestureListener {
        C15717() {
        }
    ...
    class C15728 implements AnimationListener {
        C15728() {
        }
    ...
    class C15739 implements OnTouchListener {
        C15739() {
        }
    ...
    static {
        entryDispatcher = new ConsoleEntryDispatcher(new C15651());
    }
    ...
    private static void init(Activity activity, String version, int capacity, int trim, ConsolePluginImp pluginImp) {
        ...
        ThreadUtils.runOnUIThread(new C15662(activity, version, capacity, trim, pluginImp));
    }

    private static void init0(Activity activity, String version, int capacity, int trim, ConsolePluginImp pluginImp) {
        try {
            if (instance == null) {
                Log.m885d(Tags.PLUGIN, "Initializing plugin instance (%s): %d", version, Integer.valueOf(capacity));
    ...
    public static void shutdown() {
        ...
        ThreadUtils.runOnUIThread(new C15673());
    }
    ...
    public static void show() {
        if (ThreadUtils.isRunningOnMainThread()) {
            ...
            ThreadUtils.runOnUIThread(new C15684());
        }
    }
    ...
    public static void hide() {
        if (ThreadUtils.isRunningOnMainThread()) {
            ...
            ThreadUtils.runOnUIThread(new C15695());
        }
    }
    ...
    public static void clear() {
        if (ThreadUtils.isRunningOnMainThread()) {
            ...
            ThreadUtils.runOnUIThread(new C15706());
        }
    }
    ...
    private ConsolePlugin(Activity activity, String version, int capacity, int trim, ConsolePluginImp pluginImp) {
        if (activity == null) {
            ...
            this.gestureDetector.setListener(new C15717());
        }
    }
    ...
    private boolean showConsole() {
        try {
            if (this.consoleView == null) {
                ...
                this.consoleView.startAnimation(AnimationUtils.loadAnimation(activity, C1562R.anim.lunar_console_slide_in_top));
                disableGestureRecognition();
                return true;
            }
    ...
    private boolean hideConsole() {
        try {
            ...
            Activity activity = getActivity();
            if (activity != null) {
                Animation animation = AnimationUtils.loadAnimation(activity, C1562R.anim.lunar_console_slide_out_top);
                animation.setAnimationListener(new C15728());
    ...
    public void enableGestureRecognition() {
        ...
        if (view == null) {
            ...
            view.setOnTouchListener(new C15739());
        }
    }
