...
public class ConsoleView extends LinearLayout implements Destroyable, LunarConsoleListener, OnStateChangeListener {
    ...
    class C15772 implements OnItemClickListener {
        ...
        class C15751 implements Runnable {
            ...
            C15751(View view, ConsoleEntry consoleEntry, Context context) {
                this.val$view = view;
            ...
            public void run() {
                try {
                    ...
                    Log.m887e(e, "Error while settings entry background color", new Object[0]);
                }
            }
        }
        ...
        class C15762 implements OnClickListener {
            ...
            C15762(String str, ConsoleEntry consoleEntry, String str2) {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            ...
            ThreadUtils.runOnUIThread(new C15751(view, entry, ctx), 200);
            Builder builder = new Builder(ctx);
            View contentView = LayoutInflater.from(ctx).inflate(C1562R.layout.lunar_layout_log_details_dialog, null);
            ImageView imageView = (ImageView) contentView.findViewById(C1562R.id.lunar_console_log_details_icon);
            TextView messageView = (TextView) contentView.findViewById(C1562R.id.lunar_console_log_details_message);
            TextView stacktraceView = (TextView) contentView.findViewById(C1562R.id.lunar_console_log_details_stacktrace);
            String message = entry.message;
            String stackTrace = entry.hasStackTrace() ? StackTrace.optimize(entry.stackTrace) : ConsoleView.this.getResources().getString(C1562R.string.lunar_console_log_details_dialog_no_stacktrace_warning);
            messageView.setText(message);
            stacktraceView.setText(stackTrace);
            imageView.setImageDrawable(entry.getIconDrawable(ctx));
            builder.setView(contentView);
            builder.setPositiveButton(C1562R.string.lunar_console_log_details_dialog_button_copy_to_clipboard, new C15762(message, entry, stackTrace));
            builder.create().show();
        }
    }

    /* renamed from: spacemadness.com.lunarconsole.console.ConsoleView.3 */
    class C15783 implements OnTouchListener {
        C15783() {
        }
    ...
    class C15794 implements TextWatcher {
        C15794() {
        }
    ...
    class C15805 implements View.OnClickListener {
        C15805() {
        }
    ...
    class C15816 implements OnEditorActionListener {
        C15816() {
        }
    ...
    class C15827 implements View.OnClickListener {
        C15827() {
        }
    ...
    class C15838 implements ToggleImageButton.OnStateChangeListener {
        C15838() {
        }
    ...
    class C15849 implements View.OnClickListener {
        C15849() {
        }
    ...
    public ConsoleView(Context context, Console console) {
        ...
        this.rootView = LayoutInflater.from(context).inflate(C1562R.layout.lunar_layout_console, this, false);
        addView(this.rootView, new LayoutParams(-1, -1));
        this.recyclerViewAdapter = new ConsoleAdapter(console);
        LinearLayout recyclerViewContainer = (LinearLayout) findExistingViewById(C1562R.id.lunar_console_recycler_view_container);
        ...
        this.listView.setOnItemClickListener(new C15772(console));
        this.listView.setOnTouchListener(new C15783());
        recyclerViewContainer.addView(this.listView, new LayoutParams(-1, -1));
        setupFilterTextEdit();
        this.logButton = (LogTypeButton) findExistingViewById(C1562R.id.lunar_console_log_button);
        this.warningButton = (LogTypeButton) findExistingViewById(C1562R.id.lunar_console_warning_button);
        this.errorButton = (LogTypeButton) findExistingViewById(C1562R.id.lunar_console_error_button);
        setupLogTypeButtons();
        setupOperationsButtons();
        setupFakeStatusBar();
        this.overflowText = (TextView) findExistingViewById(C1562R.id.lunar_console_text_overflow);
        reloadData();
    }

    public void destroy() {
        Log.m885d(Tags.CONSOLE, "Destroy console", new Object[0]);
    ...
    private boolean sendConsoleOutputByEmail() {
        try {
            ...
            Log.m887e(e, "Error while trying to send console output by email", new Object[0]);
            return false;
        }
    }
    ...
    private EditText setupFilterTextEdit() {
        EditText editText = (EditText) findExistingViewById(C1562R.id.lunar_console_text_edit_filter);
        ...
        editText.addTextChangedListener(new C15794());
        editText.setOnClickListener(new C15805());
        editText.setOnEditorActionListener(new C15816());
        return editText;
    }
    ...
    private void setupOperationsButtons() {
        setOnClickListener(C1562R.id.lunar_console_button_clear, new C15827());
        this.scrollLockButton = (ToggleImageButton) this.rootView.findViewById(C1562R.id.lunar_console_button_lock);
        Resources resources = getContext().getResources();
        this.scrollLockButton.setOnDrawable(resources.getDrawable(C1562R.drawable.lunar_console_icon_button_lock));
        this.scrollLockButton.setOffDrawable(resources.getDrawable(C1562R.drawable.lunar_console_icon_button_unlock));
        this.scrollLockButton.setOn(this.scrollLocked);
        this.scrollLockButton.setOnStateChangeListener(new C15838());
        setOnClickListener(C1562R.id.lunar_console_button_copy, new C15849());
        setOnClickListener(C1562R.id.lunar_console_button_email, new View.OnClickListener() {
            public void onClick(View v) {
                ConsoleView.this.sendConsoleOutputByEmail();
            }
        });
        setOnClickListener(C1562R.id.lunar_console_button_close, new View.OnClickListener() {
            public void onClick(View v) {
    ...
    private void setupFakeStatusBar() {
        TextView statusBar = (TextView) findExistingViewById(C1562R.id.lunar_console_fake_status_bar);
        statusBar.setText(String.format(getResources().getString(C1562R.string.lunar_console_title_fake_status_bar), new Object[]{ConsolePlugin.getVersion()}));
    ...
    private void updateOverflowText() {
        if (this.console.trimmedCount() > 0) {
            ...
            this.overflowText.setText(getResources().getString(C1562R.string.lunar_console_overflow_warning_text, new Object[]{Integer.valueOf(trimmedCount)}));
            return;
        }
    ...
    private boolean copyToClipboard(String outputText) {
        try {
            ...
            Log.m887e(e, "Error to copy text to clipboard", new Object[0]);
            return false;
        }
    }
