    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (rawProgress >= 0.0f && rawProgress <= 25.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor1, ((25.0f + rawProgress) * Default.HTTP_REQUEST_BACKOFF_MULT) / 100.0f);
            }
            if (rawProgress >= 0.0f && rawProgress <= 50.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor2, (Default.HTTP_REQUEST_BACKOFF_MULT * rawProgress) / 100.0f);
            }
            if (rawProgress >= 25.0f && rawProgress <= 75.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor3, ((rawProgress - 25.0f) * Default.HTTP_REQUEST_BACKOFF_MULT) / 100.0f);
            }
            if (rawProgress >= 50.0f && rawProgress <= 100.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor4, ((rawProgress - 50.0f) * Default.HTTP_REQUEST_BACKOFF_MULT) / 100.0f);
            }
            if (rawProgress >= 75.0f && rawProgress <= 100.0f) {
                canvas2 = canvas;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor1, ((rawProgress - 75.0f) * Default.HTTP_REQUEST_BACKOFF_MULT) / 100.0f);
            }
