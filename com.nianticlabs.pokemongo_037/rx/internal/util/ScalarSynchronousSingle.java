...
public final class ScalarSynchronousSingle<T> extends Single<T> {
    ...
    class C14991 implements OnSubscribe<T> {
    ...
    class C15012 implements OnSubscribe<R> {
        ...
        public void call(SingleSubscriber<? super R> child) {
            ...
            Subscriber<R> subscriber = new C15001(child);
    ...
    public <R> Single<R> scalarFlatMap(Func1<? super T, ? extends Single<? extends R>> func) {
        return Single.create(new C15012(func));
    }
}
