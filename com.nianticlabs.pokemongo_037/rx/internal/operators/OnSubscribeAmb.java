...
public final class OnSubscribeAmb<T> implements OnSubscribe<T> {
    ...
    class C13251 implements Action0 {
        final /* synthetic */ AtomicReference val$choice;
        final /* synthetic */ Selection val$selection;

        C13251(AtomicReference atomicReference, Selection selection) {
    ...
    class C13262 implements Producer {
        final /* synthetic */ AtomicReference val$choice;
        final /* synthetic */ Selection val$selection;

        C13262(AtomicReference atomicReference, Selection selection) {
            this.val$choice = atomicReference;
            this.val$selection = selection;
        }
    ...
    public void call(Subscriber<? super T> subscriber) {
        ...
        subscriber.add(Subscriptions.create(new C13251(choice, selection)));
        ...
        subscriber.setProducer(new C13262(choice, selection));
    }
