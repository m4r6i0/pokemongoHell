...
public final class OperatorDebounceWithSelector<T, U> implements Operator<T, T> {
    ...
    class C13611 extends Subscriber<T> {
        ...
        class C13601 extends Subscriber<U> {
            ...
            public void onError(Throwable e) {
                C13611.this.self.onError(e);
            }

            public void onCompleted() {
                C13611.this.state.emit(this.val$index, C13611.this.val$s, C13611.this.self);
                unsubscribe();
            }
        }

        C13611(Subscriber x0, SerializedSubscriber serializedSubscriber, SerialSubscription serialSubscription) {
        ...
        public void onNext(T t) {
            try {
                ...
                Subscriber<U> debounceSubscriber = new C13601(this.state.next(t));
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        child.add(ssub);
        return new C13611(child, s, ssub);
    }
}
