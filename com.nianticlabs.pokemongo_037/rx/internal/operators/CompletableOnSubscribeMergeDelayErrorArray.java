...
public final class CompletableOnSubscribeMergeDelayErrorArray implements CompletableOnSubscribe {
    ...
    class C13171 implements CompletableSubscriber {
        ...
        C13171(CompositeSubscription compositeSubscription, Queue queue, AtomicInteger atomicInteger, CompletableSubscriber completableSubscriber) {
        ...
        while (i$ < len$) {
            ...
            if (!set.isUnsubscribed()) {
                if (c == null) {
                    ...
                    c.subscribe(new C13171(set, q, wip, s));
                }
                i$++;
            } else {
                return;
