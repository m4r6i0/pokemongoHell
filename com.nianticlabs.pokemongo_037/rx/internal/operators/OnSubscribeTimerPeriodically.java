...
public final class OnSubscribeTimerPeriodically implements OnSubscribe<Long> {
    ...
    class C13471 implements Action0 {
        long counter;
        final /* synthetic */ Subscriber val$child;
        final /* synthetic */ Worker val$worker;

        C13471(Subscriber subscriber, Worker worker) {
    ...
    public void call(Subscriber<? super Long> child) {
        ...
        child.add(worker);
        worker.schedulePeriodically(new C13471(child, worker), this.initialDelay, this.period, this.unit);
    }
}
