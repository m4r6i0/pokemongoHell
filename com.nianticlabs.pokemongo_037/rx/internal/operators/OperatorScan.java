...
public final class OperatorScan<R, T> implements Operator<R, T> {
    ...
    class C14171 implements Func0<R> {
    ...
    class C14182 extends Subscriber<T> {
        boolean once;
        final /* synthetic */ Subscriber val$child;
        R value;

        C14182(Subscriber x0, Subscriber subscriber) {
    ...
    class C14193 extends Subscriber<T> {
        final /* synthetic */ Object val$initialValue;
        final /* synthetic */ InitialProducer val$ip;
        private R value;

        C14193(Object obj, InitialProducer initialProducer) {
            this.val$initialValue = obj;
    ...
    public OperatorScan(R initialValue, Func2<R, ? super T, R> accumulator) {
        this(new C14171(initialValue), (Func2) accumulator);
    }
    ...
    public Subscriber<? super T> call(Subscriber<? super R> child) {
        ...
        if (initialValue == NO_INITIAL_VALUE) {
            return new C14182(child, child);
        }
        InitialProducer<R> ip = new InitialProducer(initialValue, child);
        Subscriber<? super T> parent = new C14193(initialValue, ip);
        child.add(parent);
