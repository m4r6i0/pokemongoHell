...
public class SingleOperatorZip {
    ...
    static class C14851 implements OnSubscribe<R> {
        ...
        class C14841 extends SingleSubscriber<T> {
            ...
            C14841(Object[] objArr, int i, AtomicInteger atomicInteger, SingleSubscriber singleSubscriber, AtomicBoolean atomicBoolean) {
            ...
            public void onSuccess(T value) {
                ...
                if (this.val$wip.decrementAndGet() == 0) {
                    try {
                        this.val$subscriber.onSuccess(C14851.this.val$zipper.call(this.val$values));
                    } catch (Throwable e) {
        ...
        C14851(Single[] singleArr, FuncN funcN) {
        ...
        public void call(SingleSubscriber<? super R> subscriber) {
            ...
            while (i < this.val$singles.length && !compositeSubscription.isUnsubscribed() && !once.get()) {
                SingleSubscriber singleSubscriber = new C14841(values, i, wip, subscriber, once);
    ...
    public static <T, R> Single<R> zip(Single<? extends T>[] singles, FuncN<? extends R> zipper) {
        return Single.create(new C14851(singles, zipper));
    }
}
