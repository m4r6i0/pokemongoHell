...
public final class OnSubscribeRefCount<T> implements OnSubscribe<T> {
    ...
    class C13421 implements Action1<Subscription> {
        final /* synthetic */ Subscriber val$subscriber;
        final /* synthetic */ AtomicBoolean val$writeLocked;

        C13421(Subscriber subscriber, AtomicBoolean atomicBoolean) {
    ...
    class C13432 extends Subscriber<T> {
        final /* synthetic */ CompositeSubscription val$currentBase;
        final /* synthetic */ Subscriber val$subscriber;

        C13432(Subscriber x0, Subscriber subscriber, CompositeSubscription compositeSubscription) {
            this.val$subscriber = subscriber;
    ...
    class C13443 implements Action0 {
        final /* synthetic */ CompositeSubscription val$current;

        C13443(CompositeSubscription compositeSubscription) {
