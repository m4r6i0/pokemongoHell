...
public final class OperatorSkipWhile<T> implements Operator<T, T> {
    ...
    class C14311 extends Subscriber<T> {
        int index;
        boolean skipping;
        final /* synthetic */ Subscriber val$child;

        C14311(Subscriber x0, Subscriber subscriber) {
    ...
    static class C14322 implements Func2<T, Integer, Boolean> {
