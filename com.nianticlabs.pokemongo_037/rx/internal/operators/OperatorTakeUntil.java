...
public final class OperatorTakeUntil<T, E> implements Operator<T, T> {
    ...
    class C14441 extends Subscriber<T> {
        ...
        C14441(Subscriber x0, boolean x1, Subscriber subscriber) {
    ...
    class C14452 extends Subscriber<E> {
        final /* synthetic */ Subscriber val$main;

        C14452(Subscriber subscriber) {
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        Subscriber<T> main = new C14441(serial, false, serial);
        Subscriber<E> so = new C14452(main);
        serial.add(main);
        serial.add(so);
        child.add(serial);
