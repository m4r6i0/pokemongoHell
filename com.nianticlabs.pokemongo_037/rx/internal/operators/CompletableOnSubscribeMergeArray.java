...
public final class CompletableOnSubscribeMergeArray implements CompletableOnSubscribe {
    ...
    class C13161 implements CompletableSubscriber {
        ...
        C13161(CompositeSubscription compositeSubscription, AtomicBoolean atomicBoolean, CompletableSubscriber completableSubscriber, AtomicInteger atomicInteger) {
    ...
    public void call(CompletableSubscriber s) {
        ...
        while (i$ < len$) {
            ...
            if (!set.isUnsubscribed()) {
                ...
                c.subscribe(new C13161(set, once, s, wip));
                i$++;
            } else {
                return;
            }
