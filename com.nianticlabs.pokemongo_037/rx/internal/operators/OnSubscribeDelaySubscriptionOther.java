...
public final class OnSubscribeDelaySubscriptionOther<T, U> implements OnSubscribe<T> {
    ...
    class C13291 extends Subscriber<U> {
        boolean done;
        final /* synthetic */ Subscriber val$child;
        final /* synthetic */ SerialSubscription val$serial;

        C13291(Subscriber subscriber, SerialSubscription serialSubscription) {
    ...
    public void call(Subscriber<? super T> t) {
        ...
        t.add(serial);
        Subscriber<U> otherSubscriber = new C13291(Subscribers.wrap(t), serial);
