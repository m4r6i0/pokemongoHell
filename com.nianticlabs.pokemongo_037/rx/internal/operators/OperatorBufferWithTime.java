...
public final class OperatorBufferWithTime<T> implements Operator<List<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C13561 implements Action0 {
            C13561() {
            }
        ...
        void scheduleExact() {
            this.inner.schedulePeriodically(new C13561(), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C13571 implements Action0 {
            C13571() {
            }
        ...
        class C13582 implements Action0 {
        ...
        void scheduleChunk() {
            this.inner.schedulePeriodically(new C13571(), OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.unit);
        }
        ...
        void startNewChunk() {
            ...
            synchronized (this) {
                ...
                this.inner.schedule(new C13582(chunk), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
            }
        }
