...
public final class OperatorSkipTimed<T> implements Operator<T, T> {
    ...
    class C14271 implements Action0 {
        final /* synthetic */ AtomicBoolean val$gate;

        C14271(AtomicBoolean atomicBoolean) {
    ...
    class C14282 extends Subscriber<T> {
        final /* synthetic */ Subscriber val$child;
        final /* synthetic */ AtomicBoolean val$gate;

        C14282(Subscriber x0, AtomicBoolean atomicBoolean, Subscriber subscriber) {
            this.val$gate = atomicBoolean;
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        worker.schedule(new C14271(gate), this.time, this.unit);
        return new C14282(child, gate, child);
    }
}
