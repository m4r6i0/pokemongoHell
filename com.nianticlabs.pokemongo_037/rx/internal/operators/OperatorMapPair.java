...
public final class OperatorMapPair<T, U, R> implements Operator<Observable<? extends R>, T> {
    ...
    static class C13841 implements Func1<T, Observable<U>> {
    ...
    class C13862 extends Subscriber<T> {
        ...
        class C13851 implements Func1<U, R> {
        ...
        C13862(Subscriber x0, Subscriber subscriber) {
        ...
        public void onNext(T outer) {
            try {
                this.val$o.onNext(((Observable) OperatorMapPair.this.collectionSelector.call(outer)).map(new C13851(outer)));
            } catch (Throwable e) {
