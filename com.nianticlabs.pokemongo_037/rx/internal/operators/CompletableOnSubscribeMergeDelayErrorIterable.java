...
public final class CompletableOnSubscribeMergeDelayErrorIterable implements CompletableOnSubscribe {
    ...
    class C13181 implements CompletableSubscriber {
        ...
        C13181(CompositeSubscription compositeSubscription, Queue queue, AtomicInteger atomicInteger, CompletableSubscriber completableSubscriber) {
                        ...
                        if (!set.isUnsubscribed()) {
                            try {
                                ...
                                if (!set.isUnsubscribed()) {
                                    ...
                                    wip.getAndIncrement();
                                    c.subscribe(new C13181(set, queue, wip, s));
                                } else {
                                    return;
                                }
