...
public final class OperatorWindowWithTime<T> implements Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C14721 implements Action0 {
            final /* synthetic */ OperatorWindowWithTime val$this$0;

            C14721(OperatorWindowWithTime operatorWindowWithTime) {
        ...
        class C14732 implements Action0 {
            C14732() {
            }
        ...
        public ExactSubscriber(Subscriber<? super Observable<T>> child, Worker worker) {
            ...
            child.add(Subscriptions.create(new C14721(OperatorWindowWithTime.this)));
        }
        ...
        void scheduleExact() {
            this.worker.schedulePeriodically(new C14732(), 0, OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C14741 implements Action0 {
            C14741() {
            }
        ...
        class C14752 implements Action0 {
            final /* synthetic */ CountedSerializedSubject val$chunk;

            C14752(CountedSerializedSubject countedSerializedSubject) {
        ...
        void scheduleChunk() {
            this.worker.schedulePeriodically(new C14741(), OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.unit);
        }
        ...
        void startNewChunk() {
            ...
            synchronized (this.guard) {
                ...
                try {
                    ...
                    this.worker.schedule(new C14752(chunk), OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
                } catch (Throwable e) {
                    onError(e);
                }
            }
