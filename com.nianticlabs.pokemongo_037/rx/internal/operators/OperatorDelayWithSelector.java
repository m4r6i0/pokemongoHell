...
public final class OperatorDelayWithSelector<T, V> implements Operator<T, T> {
    ...
    class C13691 extends Subscriber<T> {
        ...
        class C13681 implements Func1<V, T> {
        ...
        C13691(Subscriber x0, PublishSubject publishSubject, SerializedSubscriber serializedSubscriber) {
        ...
        public void onNext(T t) {
            try {
                this.val$delayedEmissions.onNext(((Observable) OperatorDelayWithSelector.this.itemDelay.call(t)).take(1).defaultIfEmpty(null).map(new C13681(t)));
            } catch (Throwable e) {
    ...
    public Subscriber<? super T> call(Subscriber<? super T> _child) {
        ...
        return new C13691(_child, delayedEmissions, child);
    }
}
