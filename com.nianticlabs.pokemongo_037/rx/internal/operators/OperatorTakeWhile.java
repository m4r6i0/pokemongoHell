...
public final class OperatorTakeWhile<T> implements Operator<T, T> {
    ...
    class C14471 implements Func2<T, Integer, Boolean> {
    ...
    class C14482 extends Subscriber<T> {
        private int counter;
        private boolean done;
        final /* synthetic */ Subscriber val$subscriber;

        C14482(Subscriber x0, boolean x1, Subscriber subscriber) {
    ...
    public Subscriber<? super T> call(Subscriber<? super T> subscriber) {
        Subscriber<T> s = new C14482(subscriber, false, subscriber);
        subscriber.add(s);
        return s;
    }
}
