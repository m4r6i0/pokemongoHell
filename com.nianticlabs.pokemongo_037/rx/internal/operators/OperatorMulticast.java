...
public final class OperatorMulticast<T, R> extends ConnectableObservable<R> {
    ...
    class C13881 implements OnSubscribe<R> {
        ...
        C13881(Object obj, AtomicReference atomicReference, List list) {
            this.val$guard = obj;
    ...
    class C13892 implements Action0 {
        final /* synthetic */ AtomicReference val$gs;

        C13892(AtomicReference atomicReference) {
    ...
    class C13903 extends Subscriber<R> {
        final /* synthetic */ Subscriber val$s;

        C13903(Subscriber x0, Subscriber subscriber) {
    ...
    private OperatorMulticast(Object guard, AtomicReference<Subject<? super T, ? extends R>> connectedSubject, List<Subscriber<? super R>> waitingForConnect, Observable<? extends T> source, Func0<? extends Subject<? super T, ? extends R>> subjectFactory) {
        super(new C13881(guard, connectedSubject, waitingForConnect));
        this.guard = guard;
