...
public final class NotificationLite<T> {
    ...
    static class C13231 implements Serializable {
    ...
    static class C13242 implements Serializable {
    ...
    private static class OnErrorSentinel implements Serializable {
        ...
        public String toString() {
            return "Notification=>Error:" + this.f912e;
        }
    }
    ...
    static {
        ...
        ON_COMPLETED_SENTINEL = new C13231();
        ON_NEXT_NULL_SENTINEL = new C13242();
    }
    ...
    public boolean accept(Observer<? super T> o, Object n) {
        if (n == ON_COMPLETED_SENTINEL) {
            ...
            o.onError(((OnErrorSentinel) n).f912e);
            return true;
        } else {
            o.onNext(n);
            return false;
    ...
    public Throwable getError(Object n) {
        return ((OnErrorSentinel) n).f912e;
    }
}
