...
public final class OperatorDebounceWithTime<T> implements Operator<T, T> {
    ...
    class C13631 extends Subscriber<T> {
        ...
        class C13621 implements Action0 {
            ...
            public void call() {
                C13631.this.state.emit(this.val$index, C13631.this.val$s, C13631.this.self);
            }
        }

        C13631(Subscriber x0, SerialSubscription serialSubscription, Worker worker, SerializedSubscriber serializedSubscriber) {
        ...
        public void onNext(T t) {
            this.val$ssub.set(this.val$worker.schedule(new C13621(this.state.next(t)), OperatorDebounceWithTime.this.timeout, OperatorDebounceWithTime.this.unit));
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        s.add(worker);
        s.add(ssub);
        return new C13631(child, ssub, worker, s);
    }
}
