...
public final class CompletableOnSubscribeMergeIterable implements CompletableOnSubscribe {
    ...
    class C13191 implements CompletableSubscriber {
        ...
        C13191(CompositeSubscription compositeSubscription, AtomicBoolean atomicBoolean, CompletableSubscriber completableSubscriber, AtomicInteger atomicInteger) {
                        ...
                        if (!set.isUnsubscribed()) {
                            try {
                                ...
                                if (!set.isUnsubscribed()) {
                                    ...
                                    wip.getAndIncrement();
                                    c.subscribe(new C13191(set, once, s, wip));
                                } else {
                                    return;
                                }
                            } catch (Throwable e) {
