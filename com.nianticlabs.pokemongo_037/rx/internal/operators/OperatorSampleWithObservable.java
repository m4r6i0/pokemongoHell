...
public final class OperatorSampleWithObservable<T, U> implements Operator<T, T> {
    ...
    class C14151 extends Subscriber<U> {
        ...
        C14151(AtomicReference atomicReference, SerializedSubscriber serializedSubscriber, AtomicReference atomicReference2) {
    ...
    class C14162 extends Subscriber<T> {
        final /* synthetic */ SerializedSubscriber val$s;
        final /* synthetic */ Subscriber val$samplerSub;
        final /* synthetic */ AtomicReference val$value;

        C14162(AtomicReference atomicReference, SerializedSubscriber serializedSubscriber, Subscriber subscriber) {
            this.val$value = atomicReference;
            this.val$s = serializedSubscriber;
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        ...
        Subscriber<U> samplerSub = new C14151(value, s, main);
        Subscriber<T> result = new C14162(value, s, samplerSub);
        main.lazySet(result);
        child.add(result);
