...
public final class OperatorTake<T> implements Operator<T, T> {
    ...
    class C14401 extends Subscriber<T> {
        ...
        public void setProducer(Producer producer) {
            this.val$child.setProducer(new C14391(producer));
        }
    }
    ...
    public Subscriber<? super T> call(Subscriber<? super T> child) {
        Subscriber<T> parent = new C14401(child);
        if (this.limit == 0) {
            child.onCompleted();
            parent.unsubscribe();
        }
