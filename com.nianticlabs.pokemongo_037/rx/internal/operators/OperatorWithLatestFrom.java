...
public final class OperatorWithLatestFrom<T, U, R> implements Operator<R, T> {
    ...
    class C14761 extends Subscriber<T> {
        ...
        C14761(Subscriber x0, boolean x1, AtomicReference atomicReference, SerializedSubscriber serializedSubscriber) {
    ...
    class C14772 extends Subscriber<U> {
        final /* synthetic */ AtomicReference val$current;
        final /* synthetic */ SerializedSubscriber val$s;

        C14772(AtomicReference atomicReference, SerializedSubscriber serializedSubscriber) {
            this.val$current = atomicReference;
            this.val$s = serializedSubscriber;
        }
    ...
    public Subscriber<? super T> call(Subscriber<? super R> child) {
        ...
        Subscriber<T> subscriber = new C14761(s, true, current, s);
        Subscriber<U> otherSubscriber = new C14772(current, s);
        s.add(subscriber);
