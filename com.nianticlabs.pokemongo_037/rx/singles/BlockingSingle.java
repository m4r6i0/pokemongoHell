...
public class BlockingSingle<T> {
    ...
    class C15461 extends SingleSubscriber<T> {
        final /* synthetic */ CountDownLatch val$latch;
        final /* synthetic */ AtomicReference val$returnException;
        final /* synthetic */ AtomicReference val$returnItem;

        C15461(AtomicReference atomicReference, CountDownLatch countDownLatch, AtomicReference atomicReference2) {
    ...
    public T value() {
        ...
        BlockingUtils.awaitForComplete(latch, this.single.subscribe(new C15461(returnItem, latch, returnException)));
