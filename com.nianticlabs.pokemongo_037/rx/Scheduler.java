...
public abstract class Scheduler {
    ...
    public static abstract class Worker implements Subscription {
        ...
        class C12641 implements Action0 {
            long count;
            long lastNowNanos;
            long startInNanos;
            ...
            C12641(long j, long j2, MultipleAssignmentSubscription multipleAssignmentSubscription, Action0 action0, long j3) {
        ...
        public Subscription schedulePeriodically(Action0 action, long initialDelay, long period, TimeUnit unit) {
            ...
            Action0 recursiveAction = new C12641(firstNowNanos, firstStartInNanos, mas, action, periodInNanos);
