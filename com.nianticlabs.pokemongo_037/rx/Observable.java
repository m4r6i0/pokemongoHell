...
public class Observable<T> {
    ...
    class AnonymousClass14 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C12461 implements Func1<Notification<?>, Void> {
            C12461() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> notifications) {
            return (Observable) this.val$notificationHandler.call(notifications.map(new C12461()));
        }
    }
    ...
    class AnonymousClass15 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C12471 implements Func1<Notification<?>, Void> {
            C12471() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> notifications) {
            return (Observable) this.val$notificationHandler.call(notifications.map(new C12471()));
        }
    }
    ...
    class C12481 implements OnSubscribe<T> {
        C12481() {
        }
    ...
    class AnonymousClass24 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C12491 implements Func1<Notification<?>, Throwable> {
            C12491() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> notifications) {
            return (Observable) this.val$notificationHandler.call(notifications.map(new C12491()));
        }
    }
    ...
    class AnonymousClass25 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C12501 implements Func1<Notification<?>, Throwable> {
            C12501() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> notifications) {
            return (Observable) this.val$notificationHandler.call(notifications.map(new C12501()));
        }
    }
    ...
    class C12512 implements OnSubscribe<R> {
        final /* synthetic */ Operator val$operator;

        C12512(Operator operator) {
    ...
    static class C12523 implements Func2<T, T, Boolean> {
        C12523() {
        }
    ...
    static class C12534 implements Func1<List<? extends Observable<?>>, Observable<?>[]> {
        C12534() {
        }
    ...
    class C12545 implements Func2<R, T, R> {
        final /* synthetic */ Action2 val$collector;

        C12545(Action2 action2) {
    ...
    class C12556 implements Func1<T, Boolean> {
    ...
    class C12567 implements OnSubscribe<T> {
    ...
    class C12578 implements Observer<T> {
        final /* synthetic */ Action0 val$onCompleted;

        C12578(Action0 action0) {
    ...
    class C12589 implements Observer<T> {
        final /* synthetic */ Action1 val$onNotification;

        C12589(Action1 action1) {
    ...
    private static final class CountHolder {
        ...
        static class C12591 implements Func2<Integer, Object, Integer> {
            C12591() {
            }
    ...
    private static final class CountLongHolder {
        ...
        static class C12601 implements Func2<Long, Object, Long> {
            C12601() {
            }
    ...
    private static final class EmptyHolder {
        ...
        static class C12611 implements OnSubscribe<Object> {
            C12611() {
            }
        ...
        static {
            INSTANCE = Observable.create(new C12611());
        }
    }
    ...
    private static class NeverObservable<T> extends Observable<T> {
        ...
        class C12621 implements OnSubscribe<T> {
            C12621() {
            }
    ...
    private static class ThrowObservable<T> extends Observable<T> {
        ...
        class C12631 implements OnSubscribe<T> {
    ...
    public <R> R extend(Func1<? super OnSubscribe<T>, ? extends R> conversion) {
        return conversion.call(new C12481());
    }

    public final <R> Observable<R> lift(Operator<? extends R, ? super T> operator) {
        return new Observable(new C12512(operator));
    }
    ...
    public static <T> Observable<Boolean> sequenceEqual(Observable<? extends T> first, Observable<? extends T> second) {
        return sequenceEqual(first, second, new C12523());
    }
    ...
    public static <R> Observable<R> zip(Observable<? extends Observable<?>> ws, FuncN<? extends R> zipFunction) {
        return ws.toList().map(new C12534()).lift(new OperatorZip((FuncN) zipFunction));
    }
    ...
    public final <R> Observable<R> collect(Func0<R> stateFactory, Action2<R, ? super T> collector) {
        return lift(new OperatorScan((Func0) stateFactory, new C12545(collector))).last();
    }
    ...
    public final Observable<Boolean> contains(Object element) {
        return exists(new C12556(element));
    }
    ...
    public final Observable<T> defaultIfEmpty(T defaultValue) {
        return switchIfEmpty(create(new C12567(defaultValue)));
    }
    ...
    public final Observable<T> doOnCompleted(Action0 onCompleted) {
        return lift(new OperatorDoOnEach(new C12578(onCompleted)));
    }

    public final Observable<T> doOnEach(Action1<Notification<? super T>> onNotification) {
        return lift(new OperatorDoOnEach(new C12589(onNotification)));
    }
