...
final class ExecutorScheduler extends Scheduler {
    ...
    static final class ExecutorSchedulerWorker extends Worker implements Runnable {
        ...
        class C15411 implements Action0 {
            ...
            C15411(MultipleAssignmentSubscription multipleAssignmentSubscription) {
        ...
        class C15422 implements Action0 {
            final /* synthetic */ Action0 val$action;
            final /* synthetic */ MultipleAssignmentSubscription val$mas;
            final /* synthetic */ Subscription val$removeMas;

            C15422(MultipleAssignmentSubscription multipleAssignmentSubscription, Action0 action0, Subscription subscription) {
                this.val$mas = multipleAssignmentSubscription;
        ...
        public Subscription schedule(Action0 action, long delayTime, TimeUnit unit) {
            ...
            mas.set(first);
            this.tasks.add(mas);
            Subscription removeMas = Subscriptions.create(new C15411(mas));
            ScheduledAction ea = new ScheduledAction(new C15422(mas, action, removeMas));
            first.set(ea);
            try {
