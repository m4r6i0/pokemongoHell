...
public final class PublishSubject<T> extends Subject<T, T> {
    ...
    static class C15491 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ SubjectSubscriptionManager val$state;

        C15491(SubjectSubscriptionManager subjectSubscriptionManager) {
    ...
    public static <T> PublishSubject<T> create() {
        ...
        state.onTerminated = new C15491(state);
