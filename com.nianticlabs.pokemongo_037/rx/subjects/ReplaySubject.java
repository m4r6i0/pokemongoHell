...
public final class ReplaySubject<T> extends Subject<T, T> {
    ...
    static class C15501 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;

        C15501(UnboundedReplayState unboundedReplayState) {
    ...
    static class C15512 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;

        C15512(UnboundedReplayState unboundedReplayState) {
            this.val$state = unboundedReplayState;
        }
    ...
    static class C15523 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ UnboundedReplayState val$state;

        C15523(UnboundedReplayState unboundedReplayState) {
            this.val$state = unboundedReplayState;
        }
    ...
    static class C15534 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ BoundedState val$state;

        C15534(BoundedState boundedState) {
    ...
    static class C15545 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ BoundedState val$state;

        C15545(BoundedState boundedState) {
            this.val$state = boundedState;
        }
    ...
    public static <T> ReplaySubject<T> create(int capacity) {
        ...
        ssm.onStart = new C15501(state);
        ssm.onAdded = new C15512(state);
        ssm.onTerminated = new C15523(state);
    ...
    static <T> ReplaySubject<T> createWithState(BoundedState<T> state, Action1<SubjectObserver<T>> onStart) {
        SubjectSubscriptionManager<T> ssm = new SubjectSubscriptionManager();
        ssm.onStart = onStart;
        ssm.onAdded = new C15534(state);
        ssm.onTerminated = new C15545(state);
        return new ReplaySubject(ssm, ssm, state);
    }
