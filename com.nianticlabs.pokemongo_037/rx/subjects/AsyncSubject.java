...
public final class AsyncSubject<T> extends Subject<T, T> {
    ...
    static class C15471 implements Action1<SubjectObserver<T>> {
        final /* synthetic */ SubjectSubscriptionManager val$state;

        C15471(SubjectSubscriptionManager subjectSubscriptionManager) {
    ...
    public static <T> AsyncSubject<T> create() {
        ...
        state.onTerminated = new C15471(state);
