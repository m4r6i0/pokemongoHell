...
public class Single<T> {
    ...
    class AnonymousClass19 implements OnSubscribe<T> {
        ...
        class C12671 implements Action0 {
            final /* synthetic */ SingleSubscriber val$t;
            final /* synthetic */ Worker val$w;

            /* renamed from: rx.Single.19.1.1 */
            class C12661 extends SingleSubscriber<T> {
                C12661() {
                }

                public void onSuccess(T value) {
                    try {
                        C12671.this.val$t.onSuccess(value);
                    } finally {
                        C12671.this.val$w.unsubscribe();
                    }
                }

                public void onError(Throwable error) {
                    try {
                        C12671.this.val$t.onError(error);
                    } finally {
                        C12671.this.val$w.unsubscribe();
                    }
                }
            ...
            C12671(SingleSubscriber singleSubscriber, Worker worker) {
                this.val$t = singleSubscriber;
                this.val$w = worker;
            }

            public void call() {
                SingleSubscriber ssub = new C12661();
                this.val$t.add(ssub);
        ...
        public void call(SingleSubscriber<? super T> t) {
            ...
            t.add(w);
            w.schedule(new C12671(t, w));
        }
    }

    /* renamed from: rx.Single.1 */
    class C12681 implements rx.Observable.OnSubscribe<T> {
        final /* synthetic */ OnSubscribe val$f;

        /* renamed from: rx.Single.1.1 */
        class C12651 extends SingleSubscriber<T> {
            final /* synthetic */ Subscriber val$child;
            final /* synthetic */ SingleDelayedProducer val$producer;

            C12651(SingleDelayedProducer singleDelayedProducer, Subscriber subscriber) {
        ...
        C12681(OnSubscribe onSubscribe) {
        ...
        public void call(Subscriber<? super T> child) {
            ...
            SingleSubscriber<T> ss = new C12651(producer, child);
            child.add(ss);
            this.val$f.call(ss);
        }
    }
    ...
    class AnonymousClass20 implements Operator<T, T> {
        ...
        class C12691 extends Subscriber<T> {
            final /* synthetic */ Subscriber val$serial;

            C12691(Subscriber x0, boolean x1, Subscriber subscriber) {
        ...
        class C12702 implements CompletableSubscriber {
            final /* synthetic */ Subscriber val$main;
            final /* synthetic */ Subscriber val$serial;

            C12702(Subscriber subscriber, Subscriber subscriber2) {
        ...
        public Subscriber<? super T> call(Subscriber<? super T> child) {
            ...
            Subscriber<T> main = new C12691(serial, false, serial);
            CompletableSubscriber so = new C12702(main, serial);
            serial.add(main);
            child.add(serial);
    ...
    class AnonymousClass21 implements Operator<T, T> {
        ...
        class C12711 extends Subscriber<T> {
            final /* synthetic */ Subscriber val$serial;

            C12711(Subscriber x0, boolean x1, Subscriber subscriber) {
                this.val$serial = subscriber;
                super(x0, x1);
            }
        ...
        class C12722 extends Subscriber<E> {
            final /* synthetic */ Subscriber val$main;

            C12722(Subscriber subscriber) {
                this.val$main = subscriber;
            }
        ...
        public Subscriber<? super T> call(Subscriber<? super T> child) {
            Subscriber<T> serial = new SerializedSubscriber(child, false);
            Subscriber<T> main = new C12711(serial, false, serial);
            Subscriber<E> so = new C12722(main);
            serial.add(main);
            serial.add(so);
            child.add(serial);
    ...
    class C12752 implements rx.Observable.OnSubscribe<R> {
        final /* synthetic */ Operator val$lift;

        C12752(Operator operator) {
    ...
    static class C12763 implements OnSubscribe<T> {
    ...
    static class C12774 implements OnSubscribe<T> {
        final /* synthetic */ Callable val$func;

        C12774(Callable callable) {
    ...
    static class C12795 implements OnSubscribe<T> {
        final /* synthetic */ Single val$source;

        /* renamed from: rx.Single.5.1 */
        class C12781 extends SingleSubscriber<Single<? extends T>> {
            final /* synthetic */ SingleSubscriber val$child;

            C12781(SingleSubscriber singleSubscriber) {
        ...
        C12795(Single single) {
            this.val$source = single;
        }

        public void call(SingleSubscriber<? super T> child) {
            this.val$source.subscribe(new C12781(child));
        }
    }

    /* renamed from: rx.Single.6 */
    static class C12806 implements FuncN<R> {
    ...
    static class C12817 implements FuncN<R> {
    ...
    static class C12828 implements FuncN<R> {
    ...
    static class C12839 implements FuncN<R> {
    ...
    public final <R> Single<R> lift(Operator<? extends R, ? super T> lift) {
        return new Single(new C12752(lift));
    }
    ...
    public static <T> Single<T> error(Throwable exception) {
        return create(new C12763(exception));
    }
    ...
    public static <T> Single<T> merge(Single<? extends Single<? extends T>> source) {
        ...
        return create(new C12795(source));
    }
    ...
    public static <T1, T2, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Func2<? super T1, ? super T2, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2}, new C12806(zipFunction));
    }
    ...
    public static <T1, T2, T3, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Single<? extends T3> s3, Func3<? super T1, ? super T2, ? super T3, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2, s3}, new C12817(zipFunction));
    }
    ...
    public static <T1, T2, T3, T4, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Single<? extends T3> s3, Single<? extends T4> s4, Func4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2, s3, s4}, new C12828(zipFunction));
    }
    ...
    public static <T1, T2, T3, T4, T5, R> Single<R> zip(Single<? extends T1> s1, Single<? extends T2> s2, Single<? extends T3> s3, Single<? extends T4> s4, Single<? extends T5> s5, Func5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> zipFunction) {
        return SingleOperatorZip.zip(new Single[]{s1, s2, s3, s4, s5}, new C12839(zipFunction));
    }
    ...
    public final <E> Single<T> takeUntil(Single<? extends E> other) {
        return lift(new Operator<T, T>() {
            ...
            class C12731 extends Subscriber<T> {
                final /* synthetic */ Subscriber val$serial;

                C12731(Subscriber x0, boolean x1, Subscriber subscriber) {
                    this.val$serial = subscriber;
                    super(x0, x1);
                }
            ...
            class C12742 extends SingleSubscriber<E> {
                final /* synthetic */ Subscriber val$main;

                C12742(Subscriber subscriber) {
                    this.val$main = subscriber;
                }
            ...
            public Subscriber<? super T> call(Subscriber<? super T> child) {
                Subscriber<T> serial = new SerializedSubscriber(child, false);
                Subscriber<T> main = new C12731(serial, false, serial);
                SingleSubscriber so = new C12742(main);
                serial.add(main);
                serial.add(so);
                child.add(serial);
                this.val$other.subscribe(so);
