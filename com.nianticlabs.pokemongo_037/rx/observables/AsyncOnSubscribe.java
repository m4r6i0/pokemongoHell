...
public abstract class AsyncOnSubscribe<S, T> implements OnSubscribe<T> {
    ...
    static class C15031 implements Func3<S, Long, Observer<Observable<? extends T>>, S> {
        final /* synthetic */ Action3 val$next;

        C15031(Action3 action3) {
    ...
    static class C15042 implements Func3<S, Long, Observer<Observable<? extends T>>, S> {
        final /* synthetic */ Action3 val$next;

        C15042(Action3 action3) {
            this.val$next = action3;
        }
    ...
    static class C15053 implements Func3<Void, Long, Observer<Observable<? extends T>>, Void> {
        final /* synthetic */ Action2 val$next;

        C15053(Action2 action2) {
    ...
    static class C15064 implements Func3<Void, Long, Observer<Observable<? extends T>>, Void> {
        final /* synthetic */ Action2 val$next;

        C15064(Action2 action2) {
            this.val$next = action2;
        }
    ...
    static class C15075 implements Action1<Void> {
        final /* synthetic */ Action0 val$onUnsubscribe;

        C15075(Action0 action0) {
    ...
    class C15097 implements Func1<Observable<T>, Observable<T>> {
        C15097() {
        }
    ...
    static final class AsyncOuterManager<S, T> implements Producer, Subscription, Observer<Observable<? extends T>> {
        ...
        class C15101 extends Subscriber<T> {
            ...
            C15101(long j, BufferUntilSubscriber bufferUntilSubscriber) {
                this.val$expected = j;
        ...
        private void subscribeBufferToObservable(Observable<? extends T> t) {
            ...
            Subscriber s = new C15101(this.expectedDelivery, buffer);
            this.subscriptions.add(s);
            t.doOnTerminate(new C15112(s)).subscribe(s);
    ...
    public static <S, T> AsyncOnSubscribe<S, T> createSingleState(Func0<? extends S> generator, Action3<? super S, Long, ? super Observer<Observable<? extends T>>> next) {
        return new AsyncOnSubscribeImpl((Func0) generator, new C15031(next));
    }
    ...
    public static <S, T> AsyncOnSubscribe<S, T> createSingleState(Func0<? extends S> generator, Action3<? super S, Long, ? super Observer<Observable<? extends T>>> next, Action1<? super S> onUnsubscribe) {
        return new AsyncOnSubscribeImpl(generator, new C15042(next), onUnsubscribe);
    }
    ...
    public static <T> AsyncOnSubscribe<Void, T> createStateless(Action2<Long, ? super Observer<Observable<? extends T>>> next) {
        return new AsyncOnSubscribeImpl(new C15053(next));
    }
    ...
    public static <T> AsyncOnSubscribe<Void, T> createStateless(Action2<Long, ? super Observer<Observable<? extends T>>> next, Action0 onUnsubscribe) {
        return new AsyncOnSubscribeImpl(new C15064(next), new C15075(onUnsubscribe));
    }
    ...
    public final void call(Subscriber<? super T> actualSubscriber) {
        try {
            ...
            Subscriber<T> concatSubscriber = new C15086(actualSubscriber, outerProducer);
            subject.onBackpressureBuffer().concatMap(new C15097()).unsafeSubscribe(concatSubscriber);
