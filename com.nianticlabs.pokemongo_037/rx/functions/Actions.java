...
public final class Actions {
    ...
    static class C12881 implements Func0<R> {
        final /* synthetic */ Action0 val$action;
        final /* synthetic */ Object val$result;

        C12881(Action0 action0, Object obj) {
    ...
    static class C12892 implements Func1<T1, R> {
        final /* synthetic */ Action1 val$action;
        final /* synthetic */ Object val$result;

        C12892(Action1 action1, Object obj) {
    ...
    static class C12903 implements Func2<T1, T2, R> {
        final /* synthetic */ Action2 val$action;
        final /* synthetic */ Object val$result;

        C12903(Action2 action2, Object obj) {
    ...
    static class C12914 implements Func3<T1, T2, T3, R> {
        final /* synthetic */ Action3 val$action;
        final /* synthetic */ Object val$result;

        C12914(Action3 action3, Object obj) {
    ...
    static class C12925 implements Func4<T1, T2, T3, T4, R> {
        final /* synthetic */ Action4 val$action;
        final /* synthetic */ Object val$result;

        C12925(Action4 action4, Object obj) {
    ...
    static class C12936 implements Func5<T1, T2, T3, T4, T5, R> {
        final /* synthetic */ Action5 val$action;
        final /* synthetic */ Object val$result;

        C12936(Action5 action5, Object obj) {
    ...
    static class C12947 implements Func6<T1, T2, T3, T4, T5, T6, R> {
        final /* synthetic */ Action6 val$action;
        final /* synthetic */ Object val$result;

        C12947(Action6 action6, Object obj) {
    ...
    static class C12958 implements Func7<T1, T2, T3, T4, T5, T6, T7, R> {
        final /* synthetic */ Action7 val$action;
        final /* synthetic */ Object val$result;

        C12958(Action7 action7, Object obj) {
    ...
    static class C12969 implements Func8<T1, T2, T3, T4, T5, T6, T7, T8, R> {
        final /* synthetic */ Action8 val$action;
        final /* synthetic */ Object val$result;

        C12969(Action8 action8, Object obj) {
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> Func8<T1, T2, T3, T4, T5, T6, T7, T8, R> toFunc(Action8<T1, T2, T3, T4, T5, T6, T7, T8> action, R result) {
        return new C12969(action, result);
    }
