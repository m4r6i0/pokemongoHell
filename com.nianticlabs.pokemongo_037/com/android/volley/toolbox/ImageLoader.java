...
public class ImageLoader {
    ...
    class C01322 implements Listener<Bitmap> {
    ...
    class C01333 implements ErrorListener {
        final /* synthetic */ String val$cacheKey;
    ...
    public static ImageListener getImageListener(ImageView view, int defaultImageResId, int errorImageResId) {
        return new C01311(errorImageResId, view, defaultImageResId);
    }
    ...
    protected Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, ScaleType scaleType, String cacheKey) {
        return new ImageRequest(requestUrl, new C01322(cacheKey), maxWidth, maxHeight, scaleType, Config.RGB_565, new C01333(cacheKey));
    }
