...
public class NetworkImageView extends ImageView {
    ...
    class C01361 implements ImageListener {
        ...
        class C01351 implements Runnable {
            ...
            C01351(ImageContainer imageContainer) {
                this.val$response = imageContainer;
            }

            public void run() {
                C01361.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new C01351(response));
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new C01361(isInLayoutPass), maxWidth, maxHeight, scaleType);
        }
    }
