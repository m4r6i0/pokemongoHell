...
public class NetworkImageView extends ImageView {
    ...
    class C07391 implements ImageListener {
        ...
        class C07381 implements Runnable {
            ...
            C07381(ImageContainer imageContainer) {
                this.val$response = imageContainer;
            }

            public void run() {
                C07391.this.onResponse(this.val$response, false);
            }
        }
        ...
        public void onResponse(ImageContainer response, boolean isImmediate) {
            if (isImmediate && this.val$isInLayoutPass) {
                NetworkImageView.this.post(new C07381(response));
    ...
    void loadImageIfNecessary(boolean isInLayoutPass) {
        ...
        if (width != 0 || height != 0 || isFullyWrapContent) {
            ...
            this.mImageContainer = this.mImageLoader.get(this.mUrl, new C07391(isInLayoutPass), maxWidth, maxHeight);
        }
    }
