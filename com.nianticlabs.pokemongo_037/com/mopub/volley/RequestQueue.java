...
public class RequestQueue {
    ...
    class C07311 implements RequestFilter {
        ...
        if (request.shouldCache()) {
            synchronized (this.mWaitingRequests) {
                ...
                if (waitingRequests != null) {
                    if (VolleyLog.DEBUG) {
                        VolleyLog.m45v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(waitingRequests.size()), cacheKey);
                    }
