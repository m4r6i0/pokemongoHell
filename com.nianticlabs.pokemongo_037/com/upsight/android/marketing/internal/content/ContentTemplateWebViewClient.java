                ...
                if (!TextUtils.isEmpty(context)) {
                    try {
                        ...
                        if (contextElement.isJsonObject()) {
                            ...
                            this.mLogger.m207e(getClass().getSimpleName(), "Failed to parse context into JsonObject context=" + context, new Object[0]);
                        }
                    } catch (JsonSyntaxException e) {
                        this.mLogger.m208e(getClass().getSimpleName(), e, "Failed to parse context into JsonElement context=" + context, new Object[0]);
                    }
                }
            }
        }
