...
public final class BillboardFragment extends DialogFragment {
    ...
    class C10021 implements OnKeyListener {
        C10021() {
        }
    ...
    static /* synthetic */ class C10032 {
        static final /* synthetic */ int[] f263x3f5ad3de;

        static {
            f263x3f5ad3de = new int[LayoutOrientation.values().length];
            try {
                f263x3f5ad3de[LayoutOrientation.Portrait.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f263x3f5ad3de[LayoutOrientation.Landscape.ordinal()] = 2;
        ...
        if (dimensions != null) {
            for (Dimensions dimension : dimensions) {
                if (dimension.width > 0 && dimension.height > 0) {
                    switch (C10032.f263x3f5ad3de[dimension.layout.ordinal()]) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (this.mContentViewContainer != null) {
            this.mRootView = (ViewGroup) inflater.inflate(C0994R.layout.upsight_fragment_billboard, container, false);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setOnKeyListener(new C10021());
        return dialog;
    }
