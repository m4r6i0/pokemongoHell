...
public final class PushIntentService extends IntentService {
    ...
    static /* synthetic */ class C09451 {
        static final /* synthetic */ int[] f262x51d6a9c0;

        static {
            f262x51d6a9c0 = new int[UriTypes.values().length];
            try {
                f262x51d6a9c0[UriTypes.CUSTOM.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f262x51d6a9c0[UriTypes.DEFAULT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f262x51d6a9c0[UriTypes.ACTIVITY.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f262x51d6a9c0[UriTypes.PLACEMENT.ordinal()] = 4;
        ...
        if (!TextUtils.isEmpty(stringValue) && TextUtils.isDigitsOnly(stringValue)) {
            try {
                ...
                if (defaultValue == null) {
                    logger.m208e(LOG_TAG, e, String.format("Could not parse %s. Setting to null.", new Object[]{stringValue}), new Object[0]);
                } else {
                    logger.m208e(LOG_TAG, e, String.format("Could not parse %s. Setting to %d.", new Object[]{stringValue, defaultValue}), new Object[0]);
                }
            }
        }
        return integerValue;
    ...
    private void interpretPushEvent(Bundle extras) {
        ...
        if (uri != null) {
            ...
            switch (C09451.f262x51d6a9c0[checkUri(logger, uri).ordinal()]) {
    ...
    public UriTypes checkUri(UpsightLogger logger, Uri uri) {
        ...
        if (TextUtils.isEmpty(host) || TextUtils.isEmpty(scheme)) {
            logger.m207e(LOG_TAG, String.format("Invalid URI, host or scheme is null or empty: %s.", new Object[]{uri}), new Object[0]);
            ...
            try {
                ...
                logger.m207e(LOG_TAG, String.format("Nothing registered for %s", new Object[]{uri}), new Object[0]);
                return UriTypes.INVALID;
            }
        ...
        try {
            ...
            if (bundle != null && bundle.containsKey(NOTIFICATION_BUILDER_FACTORY_KEY_NAME)) {
                try {
                    ...
                    logger.m207e(Upsight.LOG_TAG, String.format("Class %s must implement %s!", new Object[]{clazz.getName(), UpsightPushNotificationBuilderFactory.class.getName()}), new Object[0]);
                } catch (ClassNotFoundException e) {
                    logger.m207e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s was not found.", new Object[]{customBuilderClassName}), e);
                } catch (InstantiationException e2) {
                    logger.m207e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s does not have public access.", new Object[]{customBuilderClassName}), e2);
                } catch (IllegalAccessException e3) {
                    logger.m207e(Upsight.LOG_TAG, String.format("Unexpected error: Class: %s could not be instantiated.", new Object[]{customBuilderClassName}), e3);
                }
            }
