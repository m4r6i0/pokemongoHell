...
public class GooglePushServices implements UpsightGooglePushServicesApi {
    ...
    class C09371 implements OnSubscribe<String> {
    ...
    class C09382 implements Observer<String> {
        C09382() {
        }
    ...
    class C09393 implements OnSubscribe<String> {
        C09393() {
        }
    ...
    class C09404 implements Observer<String> {
        C09404() {
        }
    ...
    class C09415 implements Action1<Config> {
    ...
    private void registerInBackground(String projectId) {
        ...
        Observable.create(new C09371(projectId)).subscribeOn(this.mComputationScheduler).observeOn(HandlerScheduler.from(this.mUiThreadHandler)).subscribe(new C09382());
    }
    ...
    private void unregisterInBackground() {
        ...
        Observable.create(new C09393()).subscribeOn(this.mComputationScheduler).observeOn(HandlerScheduler.from(this.mUiThreadHandler)).subscribe(new C09404());
    }

    private void registerPushToken(String pushToken) {
        try {
            this.mPushConfigManager.fetchCurrentConfigObservable().subscribeOn(this.mUpsight.getCoreComponent().subscribeOnScheduler()).observeOn(this.mUpsight.getCoreComponent().observeOnScheduler()).subscribe(new C09415(pushToken));
        } catch (IOException e) {
