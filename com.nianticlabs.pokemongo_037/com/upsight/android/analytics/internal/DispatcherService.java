...
public class DispatcherService extends Service {
    ...
    class C09012 implements UpsightDataStoreListener<Set<ApplicationStatus>> {
        C09012() {
        }
    ...
    public void onCreate() {
        ...
        if (extension != null) {
            ...
            upsight.getDataStore().fetch(ApplicationStatus.class, new C09012());
        }
    }
