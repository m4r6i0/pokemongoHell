...
public class ActionMap<T extends Actionable, U extends ActionContext> extends HashMap<String, List<Action<T, U>>> {
                    ...
                    if (numActions > 0) {
                        ...
                        for (int i = 0; i < numActions; i++) {
                            ...
                            try {
                                ...
                                actionContext.mLogger.m208e(TAG, e, "Unable to create action from actionJSON=" + actionJSON, new Object[0]);
                            }
                        }
                        if (actions.size() > 0) {
    ...
    public synchronized void executeActions(String trigger, T object) {
        this.mLogger.m209i(TAG, LOG_TEMPLATE_TRIGGER, trigger, object.getId());
