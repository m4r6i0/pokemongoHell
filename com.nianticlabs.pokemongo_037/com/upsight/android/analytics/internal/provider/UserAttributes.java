...
final class UserAttributes extends UpsightUserAttributes {
    ...
    public void put(String key, String value) throws IllegalArgumentException {
        if (value == null) {
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("No metadata found with android:name %sstring.%s in the Android Manifest", new Object[]{UpsightUserAttributes.USER_ATTRIBUTES_PREFIX, key}), new Object[0]);
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("The user attribute %s must be of type string", new Object[]{key}), new Object[0]);
    ...
    public void put(String key, Integer value) {
        if (value == null) {
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("No metadata found with android:name %sinteger.%s in the Android Manifest", new Object[]{UpsightUserAttributes.USER_ATTRIBUTES_PREFIX, key}), new Object[0]);
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("The user attribute %s must be of type integer", new Object[]{key}), new Object[0]);
    ...
    public void put(String key, Boolean value) {
        if (value == null) {
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("No metadata found with android:name %sboolean.%s in the Android Manifest", new Object[]{UpsightUserAttributes.USER_ATTRIBUTES_PREFIX, key}), new Object[0]);
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("The user attribute %s must be of type boolean", new Object[]{key}), new Object[0]);
    ...
    public void put(String key, Float value) {
        if (value == null) {
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("No metadata found with android:name %sfloat.%s in the Android Manifest", new Object[]{UpsightUserAttributes.USER_ATTRIBUTES_PREFIX, key}), new Object[0]);
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("The user attribute %s must be of type float", new Object[]{key}), new Object[0]);
    ...
    public void put(String key, Date value) {
        if (value == null) {
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("No metadata found with android:name %sdatetime.%s in the Android Manifest", new Object[]{UpsightUserAttributes.USER_ATTRIBUTES_PREFIX, key}), new Object[0]);
            ...
            this.mLogger.m213w(Upsight.LOG_TAG, String.format("The user attribute %s must be of type datetime", new Object[]{key}), new Object[0]);
            ...
            if ("string".equals(type)) {
                ...
                if (DATETIME_DEFAULT_VALUE_PATTERN.matcher(defaultDatetime).matches()) {
                    try {
                        ...
                        this.mLogger.m207e(Upsight.LOG_TAG, msg, e);
                ...
                this.mLogger.m207e(Upsight.LOG_TAG, msg, new Object[0]);
