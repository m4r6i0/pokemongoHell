...
public final class AnalyticsSchedulersModule {
    ...
    class C08971 implements ThreadFactory {
    ...
    public Scheduler provideSendingExecutor() {
        return Schedulers.from(new ThreadPoolExecutor(STD_SENDING_THREADS_NUM, MAX_SENDING_THREADS_NUM, 15, TimeUnit.MINUTES, new LinkedBlockingQueue(), new C08971()));
    }
