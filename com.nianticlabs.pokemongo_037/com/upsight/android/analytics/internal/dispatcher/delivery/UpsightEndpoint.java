...
class UpsightEndpoint {
    ...
    public Response send(UpsightRequest request) throws IOException {
        ...
        try {
            ...
            this.mLogger.m205d(Upsight.LOG_TAG, LOG_TEXT_POSTING + refId + LOG_TEXT_TO + this.mEndpointAddress + LOG_TEXT_REQUEST_BODY + this.mRequestLoggingGson.toJson((Object) request), new Object[0]);
            ...
            this.mLogger.m205d(Upsight.LOG_TAG, sb.toString(), new Object[0]);
    ...
    private String getVerifiedResponse(HttpURLConnection urlConnection) throws IOException {
        ...
        try {
            ...
            this.mLogger.m208e(Upsight.LOG_TAG, e, "Message signature is not valid Base64. X-US-DIGEST: " + signature, new Object[0]);
            return respBody;
        }
    }
}
