    ...
    BouncySignatureVerifier(UpsightContext upsight) {
        ...
        try {
            if (TextUtils.isEmpty(publicKeyString)) {
                this.mLogger.m207e(Upsight.LOG_TAG, "Please check your public key.", new Object[0]);
                return;
            }
            ...
            this.mSigner = signer;
            this.mLogger.m205d(Upsight.LOG_TAG, "Public key: " + publicKey, new Object[0]);
        } catch (IOException e2) {
            e = e2;
            this.mLogger.m208e(Upsight.LOG_TAG, e, "Failed to initialize " + BouncySignatureVerifier.class.getSimpleName(), new Object[0]);
    ...
    public synchronized boolean verify(byte[] message, byte[] signature) {
        ...
        if (this.mSigner != null) {
            try {
                ...
                this.mLogger.m208e(Upsight.LOG_TAG, e, "Failed to verify signature " + BouncySignatureVerifier.class.getSimpleName(), new Object[0]);
            }
        }
        if (!isVerified) {
            this.mLogger.m207e(Upsight.LOG_TAG, "Failed to verify signature. Please check your public key.", new Object[0]);
        }
        return isVerified;
    }
}
