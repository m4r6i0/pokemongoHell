...
public class BatchSender {
    ...
    class C09121 implements Action0 {
        final /* synthetic */ Request val$request;

        C09121(Request request) {
    ...
    class C09132 implements Action0 {
        final /* synthetic */ Request val$request;

        C09132(Request request) {
            this.val$request = request;
        }
        ...
        public void run() {
            if (NetworkHelper.isConnected(BatchSender.this.mUpsight)) {
                try {
                    ...
                    BatchSender.this.mLogger.m207e("BatchSender", "Received " + resp.statusCode + " HTTP response code from server", new Object[0]);
    ...
    public void submitRequest(Request request) {
        this.mBatchSendExecutor.createWorker().schedule(new C09121(request));
    }
    ...
    private void sendFailed(Request request, FailReason failReason, String errorString) {
        ...
        if (tryCount.intValue() > 0) {
            ...
            this.mRetryExecutor.createWorker().schedule(new C09132(request), (long) this.mConfig.retryInterval, TimeUnit.SECONDS);
            return;
        }
        this.mTryCounts.remove(request);
        for (Packet packet : request.batch.getPackets()) {
