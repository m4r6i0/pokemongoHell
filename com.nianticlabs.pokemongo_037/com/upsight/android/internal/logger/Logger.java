...
public final class Logger implements UpsightLogger {
    ...
    class C09511 implements UpsightDataStoreListener<LogMessage> {
        C09511() {
        }
    ...
    public void m231v(String tag, String message, Object... args) {
        log(Level.VERBOSE, tag, null, message, args);
    }

    public void m232v(String tag, Throwable tr, String message, Object... args) {
        log(Level.VERBOSE, tag, tr, message, args);
    }

    public void m225d(String tag, String message, Object... args) {
        log(Level.DEBUG, tag, null, message, args);
    }

    public void m226d(String tag, Throwable tr, String message, Object... args) {
        log(Level.DEBUG, tag, tr, message, args);
    }

    public void m229i(String tag, String message, Object... args) {
        log(Level.INFO, tag, null, message, args);
    }

    public void m230i(String tag, Throwable tr, String message, Object... args) {
        log(Level.INFO, tag, tr, message, args);
    }

    public void m233w(String tag, String message, Object... args) {
        log(Level.WARN, tag, null, message, args);
    }

    public void m234w(String tag, Throwable tr, String message, Object... args) {
        log(Level.WARN, tag, tr, message, args);
    }

    public void m227e(String tag, String message, Object... args) {
        log(Level.ERROR, tag, null, message, args);
    }

    public void m228e(String tag, Throwable tr, String message, Object... args) {
    ...
    private void log(Level priority, String tag, Throwable t, String message, Object... args) {
        ...
        this.mDataStore.store(new LogMessage(tag, priority, formatString(message, args), writer.getBuffer().toString()), new C09511());
    }
