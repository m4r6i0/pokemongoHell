...
public class InAppBillingConnection {
    ...
    class C10631 implements ServiceConnection {
        C10631() {
        }
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            try {
                ...
                FuseLog.m237e("Fuse-InAppBillingConnection", "Exception thrown while attempting to retrieve IInAppBillingService", t);
                InAppBillingConnection.this.closeConnection();
    ...
    class C10642 extends ArrayList<String> {
    ...
    public String getLocalPriceForProductId(@NonNull String productId) {
        ...
        new Bundle().putStringArrayList("ITEM_ID_LIST", new C10642(productId));
        try {
            ...
            FuseLog.m237e("Fuse-InAppBillingConnection", "Exception thrown while getting SKU Details", t);
        }
        return null;
    }
}
