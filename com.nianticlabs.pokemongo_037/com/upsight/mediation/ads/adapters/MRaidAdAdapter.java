...
public class MRaidAdAdapter extends NetworkWrapperFuseInternal implements MRAIDNativeFeatureListener, MRAIDInterstitialListener {
    ...
    public void mraidNativeFeatureCallTel(String url) {
        FuseLog.m239v(TAG, "MRAID Ad Wants to make phone call " + url);
    }

    public void mraidNativeFeatureCreateCalendarEvent(String eventJSON) {
        FuseLog.m239v(TAG, "MRAID Ad Wants to create calendar event: " + eventJSON);
    }

    public void mraidNativeFeaturePlayVideo(String url) {
        FuseLog.m239v(TAG, "MRAID Ad Wants to play video: " + url);
        MRaidActivity displayedActivity = getMRaidActivity();
        if (displayedActivity != null) {
    ...
    public void mraidNativeFeatureOpenBrowser(String url) {
        FuseLog.m239v(TAG, "Ad Wants to display browser: " + url);
    ...
    public void mraidNativeFeatureOpenMarket(String url) {
        FuseLog.m239v(TAG, "Ad Wants to display market: " + url);
        if (this.clickBeacon != null) {
            sendRequestToBeacon(this.clickBeacon);
        }
        onAdClicked();
    ...
    public void mraidNativeFeatureStorePicture(String url) {
        FuseLog.m239v(TAG, "Ad Wants to store a picture: " + url);
    }

    public void mraidNativeFeatureSendSms(String url) {
        FuseLog.m239v(TAG, "Ad Wants to send SMS: " + url);
    }
