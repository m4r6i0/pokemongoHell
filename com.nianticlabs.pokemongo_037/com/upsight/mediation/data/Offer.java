...
public class Offer {
    ...
    public int hashCode() {
        ...
        hashCode2 = (((hashCode2 + hashCode) * 31) + this.f271t) * 31;
    ...
    public String toString() {
        return "Offer{id=" + this.id + ", itemId='" + this.itemId + '\'' + ", contentId=" + this.contentId + ", vg_virtualGoodID=" + this.vg_virtualGoodID + ", vg_currencyID=" + this.vg_currencyID + ", adZoneID=" + this.adZoneID + ", zoneName='" + this.zoneName + '\'' + ", t=" + this.f271t + ", itemName='" + this.itemName + '\'' + ", itemQuantity=" + this.itemQuantity + ", purchasePrice=" + this.purchasePrice + ", purchaseCurrency='" + this.purchaseCurrency + '\'' + ", type=" + this.type + ", offerHtml='" + this.offerHtml + '\'' + ", startTime=" + this.startTime + ", endTime=" + this.endTime + ", metadata='" + this.metadata + '\'' + ", consumed=" + this.consumed + '}';
    }
}
