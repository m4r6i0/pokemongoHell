...
public class MRAIDNativeFeatureManager {
    ...
    public boolean isCalendarSupported() {
        ...
        MRAIDLog.m249v(TAG, "isCalendarSupported " + retval);
        return retval;
    }
    ...
    public boolean isInlineVideoSupported() {
        ...
        MRAIDLog.m249v(TAG, "isInlineVideoSupported " + retval);
        return retval;
    }
    ...
    public boolean isSmsSupported() {
        ...
        MRAIDLog.m249v(TAG, "isSmsSupported " + retval);
        return retval;
    }
    ...
    public boolean isStorePictureSupported() {
        ...
        MRAIDLog.m249v(TAG, "isStorePictureSupported " + retval);
        return retval;
    }
    ...
    public boolean isTelSupported() {
        ...
        MRAIDLog.m249v(TAG, "isTelSupported " + retval);
        return retval;
    }
}
