...
final class C0885u implements UncaughtExceptionHandler {
    private volatile UncaughtExceptionHandler f228a;

    C0885u() {
    }

    final synchronized boolean m190a() {
        boolean z;
        C0885u defaultUncaughtExceptionHandler = Thread.getDefaultUncaughtExceptionHandler();
        if (defaultUncaughtExceptionHandler == this) {
            z = false;
        } else {
            this.f228a = defaultUncaughtExceptionHandler;
    ...
    public final synchronized void uncaughtException(Thread thread, Throwable th) {
        try {
            ...
            error.initCause(th);
            this.f228a.uncaughtException(thread, error);
        } catch (Throwable th2) {
