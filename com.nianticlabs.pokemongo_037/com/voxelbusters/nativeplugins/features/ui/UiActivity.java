...
public class UiActivity extends Activity {
    ...
    class C10902 implements OnClickListener {
        ...
        C10902(String[] strArr, int i, String str) {
    ...
    class C10913 implements OnClickListener {
        private final /* synthetic */ int val$index;
        private final /* synthetic */ EditText val$promptField;
        private final /* synthetic */ String[] val$tempButtonList;

        C10913(EditText editText, String[] strArr, int i) {
    ...
    class C10924 implements OnClickListener {
        ...
        C10924(String[] strArr, int i, EditText editText, EditText editText2) {
    ...
    protected void onResume() {
        ...
        if (this.paused) {
            finish();
            new Handler().postDelayed(new C10891(), 10);
        }
    }
    ...
    private void showAlertDialog(Bundle bundle) {
        ...
        for (int eachButtonIndex = 0; eachButtonIndex < length; eachButtonIndex++) {
            this.alertDialog.setButton(-1 - eachButtonIndex, buttonsList[eachButtonIndex], new C10902(tempButtonList, eachButtonIndex, tag));
        }
    ...
    private void showSinglePrompt(Bundle bundle) {
        ...
        String[] tempButtonList = buttonsList;
        for (int eachButtonIndex = 0; eachButtonIndex < length; eachButtonIndex++) {
            this.alertDialog.setButton(-1 - eachButtonIndex, buttonsList[eachButtonIndex], new C10913(promptField, tempButtonList, eachButtonIndex));
        }
        this.alertDialog.show();
    }
    ...
    private void showLoginPrompt(Bundle bundle) {
        ...
        for (int eachButtonIndex = 0; eachButtonIndex < length; eachButtonIndex++) {
            this.alertDialog.setButton(-1 - eachButtonIndex, finalButtonList[eachButtonIndex], new C10924(finalButtonList, eachButtonIndex, usernameField, passwordField));
        }
        this.alertDialog.show();
    }
