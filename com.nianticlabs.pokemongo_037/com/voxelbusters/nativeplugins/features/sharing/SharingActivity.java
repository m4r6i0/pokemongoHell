...
public class SharingActivity extends Activity {
    ...
    class C10882 implements OnKeyListener {
        C10882() {
        }
    ...
    private void shareItem(String message, String urlString, String imagePath, String type, String[] excludedShareOptions) {
        ...
        if (failedSharing) {
            Builder alertDialogBuilder = new Builder(this).setTitle("Share").setMessage("No services found!").setPositiveButton(17039370, new C10871());
            alertDialogBuilder.setOnKeyListener(new C10882());
