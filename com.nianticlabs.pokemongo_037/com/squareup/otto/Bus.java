...
public class Bus {
    ...
    class C08281 extends ThreadLocal<ConcurrentLinkedQueue<EventWithHandler>> {
        C08281() {
        }
    ...
    class C08292 extends ThreadLocal<Boolean> {
        C08292() {
        }
    ...
    Bus(ThreadEnforcer enforcer, String identifier, HandlerFinder handlerFinder) {
        ...
        this.eventsToDispatch = new C08281();
        this.isDispatching = new C08292();
