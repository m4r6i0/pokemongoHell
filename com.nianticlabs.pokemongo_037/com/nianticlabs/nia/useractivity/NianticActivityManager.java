...
public class NianticActivityManager extends ContextService {
    ...
    class C07791 implements Listener {
        C07791() {
        }
    ...
    class C07802 implements Runnable {
        ...
        C07802(ActivityRecognitionResult activityRecognitionResult) {
    ...
    public NianticActivityManager(Context context, long nativeClassPointer) {
        ...
        this.googleApiListener = new C07791();
    ...
    public void receiveUpdateActivity(ActivityRecognitionResult result) {
        ContextService.runOnServiceHandler(new C07802(result));
    }
