...
public class ActivityRecognitionService extends IntentService {
    ...
    class C07781 implements ConnectionCallbacks {
        C07781() {
        }
    ...
    private void unregisterIntent() {
        this.googleApiClient = new Builder(this).addApi(ActivityRecognition.API).addConnectionCallbacks(new C07781()).build();
