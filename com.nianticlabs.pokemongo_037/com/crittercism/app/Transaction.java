...
public abstract class Transaction {
    ...
    public abstract void m36a(int i);

    public abstract void m37b();

    public abstract void m38c();

    public abstract int m39d();

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.crittercism.app.Transaction m34a(java.lang.String r3) {
        /*
    ...
    L_0x000a:
        ...
        crittercism.android.dx.m780b(r0, r1);	 Catch:{ ThreadDeath -> 0x0030, Throwable -> 0x0038 }
        r0 = new crittercism.android.be;	 Catch:{ ThreadDeath -> 0x0030, Throwable -> 0x0038 }
        r0.<init>();	 Catch:{ ThreadDeath -> 0x0030, Throwable -> 0x0038 }
    L_0x001b:
        return r0;
    L_0x001c:
        r1 = crittercism.android.az.m400A();	 Catch:{ ThreadDeath -> 0x0030, Throwable -> 0x0038 }
        r0 = r1.f365b;	 Catch:{ ThreadDeath -> 0x0030, Throwable -> 0x0038 }
        if (r0 == 0) goto L_0x0042;
    L_0x0024:
        r0 = r1.m404B();	 Catch:{ ThreadDeath -> 0x0030, Throwable -> 0x0038 }
    ...
    L_0x0038:
        r0 = move-exception;
        crittercism.android.dx.m777a(r0);
