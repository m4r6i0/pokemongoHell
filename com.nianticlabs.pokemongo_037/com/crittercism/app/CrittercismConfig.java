...
public class CrittercismConfig {
    ...
    public CrittercismConfig(JSONObject config) {
        ...
        this.f23j = new LinkedList();
        this.f24k = new LinkedList();
        this.f15b = m29a(config, "customVersionName", this.f15b);
        this.f17d = m31a(config, "includeVersionCode", this.f17d);
        this.f18e = m31a(config, "installNdk", this.f18e);
        this.f16c = m31a(config, "delaySendingAppLoad", this.f16c);
        this.f19f = m31a(config, "shouldCollectLogcat", this.f19f);
        this.f14a = m29a(config, "nativeDumpPath", this.f14a);
        this.f21h = m29a(config, "notificationTitle", this.f21h);
        this.f20g = m31a(config, "installApm", this.f20g);
    }
    ...
    public int hashCode() {
        int i;
        int i2 = 1;
        int hashCode = this.f24k.hashCode() + ((((((((((m28a(this.f15b) + 0) * 31) + m28a(this.f21h)) * 31) + m28a(this.f14a)) * 31) + m28a(this.f22i)) * 31) + this.f23j.hashCode()) * 31);
