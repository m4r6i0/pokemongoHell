...
public class CritterUserData {
    ...
    public boolean shouldShowRateMyAppAlert() {
        ...
        if (this.f8b) {
            dx.m782c("User has opted out of Crittercism.  Returning false.");
        } else {
            dx.m782c("CritterUserData instance has no value for shouldShowMyRateAppAlert().  Defaulting to false.");
        }
        return false;
    }
    ...
    public String getRateMyAppTitle() {
        if (!this.f7a.containsKey(Keys.TITLE)) {
            if (this.f8b) {
                dx.m782c("User has opted out of Crittercism.  Returning null.");
            } else {
                dx.m782c("CritterUserData instance has no value for getRateMyAppTitle().  Returning null.");
            }
        }
    ...
    public String getRateMyAppMessage() {
        if (!this.f7a.containsKey(Keys.MESSAGE)) {
            if (this.f8b) {
                ...
                dx.m782c("CritterUserData instance has no value for getRateMyAppMessage().  Returning null.");
            }
        }
    ...
    public boolean crashedOnLastLoad() {
        ...
        if (this.f8b) {
            ...
            dx.m782c("CritterUserData instance has no value for crashedOnLastLoad().  Defaulting to false.");
        }
        return false;
    }
    ...
    public String getUserUUID() {
        if (!this.f7a.containsKey("userUUID")) {
            if (this.f8b) {
                ...
                dx.m782c("CritterUserData instance has no value for getUserUUID().  Returning null.");
            }
        }
