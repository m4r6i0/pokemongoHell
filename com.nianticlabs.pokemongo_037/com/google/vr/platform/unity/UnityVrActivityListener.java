...
public class UnityVrActivityListener implements AndroidInputListener {
    ...
    public UnityVrActivityListener() {
        ...
        this.touchX = 0;
        this.touchY = 0;
        this.vrBackButtonListener = new C07251();
    ...
    public void injectSingleTap() {
        if (!this.tapInProgress) {
            ...
            int x = this.touchX;
            int y = this.touchY;
            this.unityActivity.getUnityPlayer().postDelayed(new C07262(x, y, injectTouchDown(x, y)), TAP_TIME_MS);
        }
    }
    ...
    public void injectKeyPress(int keyCode) {
        ...
        this.unityActivity.getUnityPlayer().postDelayed(new C07273(keyCode), TAP_TIME_MS);
    }
}
