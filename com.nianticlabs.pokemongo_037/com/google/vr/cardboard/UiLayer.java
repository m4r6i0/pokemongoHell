...
public class UiLayer {
    ...
    class C07183 implements Runnable {
        final /* synthetic */ ViewGroup val$parentView;

        C07183(ViewGroup viewGroup) {
    ...
    class C07227 implements Runnable {
        final /* synthetic */ boolean val$enabled;
    ...
    public void attachUiLayer(ViewGroup parentView) {
        ((Activity) this.context).runOnUiThread(new C07183(parentView));
    }

    public void setEnabled(boolean enabled) {
        ((Activity) this.context).runOnUiThread(new C07194(enabled));
    }

    public void setSettingsButtonEnabled(boolean enabled) {
        this.isSettingsButtonEnabled = enabled;
        ((Activity) this.context).runOnUiThread(new C07205(enabled));
    }

    public void setBackButtonListener(Runnable runnable) {
        this.backButtonRunnable = runnable;
        ((Activity) this.context).runOnUiThread(new C07216(runnable));
    }

    public void setAlignmentMarkerEnabled(boolean enabled) {
        this.isAlignmentMarkerEnabled = enabled;
        ((Activity) this.context).runOnUiThread(new C07227(enabled));
    }
