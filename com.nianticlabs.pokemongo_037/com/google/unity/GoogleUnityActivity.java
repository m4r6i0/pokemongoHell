...
public class GoogleUnityActivity extends Activity {
    ...
    class C07091 implements OnTouchListener {
        C07091() {
        }
    ...
    class C07102 implements OnGenericMotionListener {
        C07102() {
        }
    ...
    class C07113 implements OnKeyListener {
        C07113() {
        }
    ...
    class C07124 implements Runnable {
        ...
        C07124(Activity activity, int i) {
    ...
    class C07145 implements OnSystemUiVisibilityChangeListener {
        ...
        C07145(Handler handler) {
            this.val$handler = handler;
        }

        public void onSystemUiVisibilityChange(int visibility) {
            if ((visibility & 2) == 0) {
                this.val$handler.postDelayed(new C07131(), 2000);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mUnityPlayer.setOnTouchListener(new C07091());
        this.mUnityPlayer.setOnGenericMotionListener(new C07102());
        this.mUnityPlayer.setOnKeyListener(new C07113());
    ...
    public void showAndroidViewLayer(int layoutResId) {
        runOnUiThread(new C07124(this, layoutResId));
    }
    ...
    private void startImmersiveMode() {
        getWindow().getDecorView().setOnSystemUiVisibilityChangeListener(new C07145(new Handler()));
    }
