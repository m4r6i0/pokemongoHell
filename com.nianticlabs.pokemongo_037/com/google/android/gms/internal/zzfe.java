...
public class zzfe extends zzfh {
    ...
    class C05111 implements OnClickListener {
        ...
        C05111(zzfe com_google_android_gms_internal_zzfe, String str, String str2) {
    ...
    class C05122 implements OnClickListener {
        ...
        C05122(zzfe com_google_android_gms_internal_zzfe) {
            this.zzAu = com_google_android_gms_internal_zzfe;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzp.zzbv().zzaB(zzaj)) {
                    ...
                    zzK.setTitle(zzp.zzby().zzd(C0138R.string.store_picture_title, "Save image"));
                    zzK.setMessage(zzp.zzby().zzd(C0138R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzK.setPositiveButton(zzp.zzby().zzd(C0138R.string.accept, "Accept"), new C05111(this, str, zzaj));
                    zzK.setNegativeButton(zzp.zzby().zzd(C0138R.string.decline, "Decline"), new C05122(this));
                    zzK.create().show();
                    return;
                }
