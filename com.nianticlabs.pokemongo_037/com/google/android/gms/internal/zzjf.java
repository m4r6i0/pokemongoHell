...
public class zzjf extends WebChromeClient {
    ...
    static class C05641 implements OnCancelListener {
        final /* synthetic */ JsResult zzKD;

        C05641(JsResult jsResult) {
            this.zzKD = jsResult;
        }
    ...
    static class C05652 implements OnClickListener {
        final /* synthetic */ JsResult zzKD;

        C05652(JsResult jsResult) {
            this.zzKD = jsResult;
        }
    ...
    static class C05663 implements OnClickListener {
        final /* synthetic */ JsResult zzKD;

        C05663(JsResult jsResult) {
            this.zzKD = jsResult;
        }
    ...
    static class C05674 implements OnCancelListener {
        final /* synthetic */ JsPromptResult zzKE;

        C05674(JsPromptResult jsPromptResult) {
    ...
    static class C05685 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzKE;

        C05685(JsPromptResult jsPromptResult) {
            this.zzKE = jsPromptResult;
        }
    ...
    static class C05696 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzKE;
        final /* synthetic */ EditText zzKF;

        C05696(JsPromptResult jsPromptResult, EditText editText) {
            this.zzKE = jsPromptResult;
            this.zzKF = editText;
        }
    ...
    private static void zza(Builder builder, String str, JsResult jsResult) {
        builder.setMessage(str).setPositiveButton(17039370, new C05663(jsResult)).setNegativeButton(17039360, new C05652(jsResult)).setOnCancelListener(new C05641(jsResult)).create().show();
    }
    ...
    private static void zza(Context context, Builder builder, String str, String str2, JsPromptResult jsPromptResult) {
        ...
        builder.setView(linearLayout).setPositiveButton(17039370, new C05696(jsPromptResult, editText)).setNegativeButton(17039360, new C05685(jsPromptResult)).setOnCancelListener(new C05674(jsPromptResult)).create().show();
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C05707.zzKG[consoleMessage.messageLevel().ordinal()]) {
