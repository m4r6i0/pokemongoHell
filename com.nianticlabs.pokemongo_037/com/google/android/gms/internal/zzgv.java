...
public final class zzgv {
    ...
    class C05331 implements zzdk {
        final /* synthetic */ zzgv zzFT;

        C05331(zzgv com_google_android_gms_internal_zzgv) {
    ...
    class C05342 implements zzdk {
        final /* synthetic */ zzgv zzFT;

        C05342(zzgv com_google_android_gms_internal_zzgv) {
            this.zzFT = com_google_android_gms_internal_zzgv;
        }
            ...
            synchronized (this.zzFT.zzpd) {
                ...
                if (this.zzFT.zzBY.equals(com_google_android_gms_internal_zzgx.getRequestId())) {
                    ...
                    if (url.contains("%40mediation_adapters%40")) {
                        ...
                        zzb.m41v("Ad request URL modified to " + replaceAll);
                    }
                    this.zzFT.zzFP.zzf(com_google_android_gms_internal_zzgx);
                    return;
                }
    ...
    public zzgv(String str, String str2) {
        ...
        this.zzFP = new zzin();
        this.zzFR = new C05331(this);
        this.zzFS = new C05342(this);
        this.zzFO = str2;
        this.zzBY = str;
    }
