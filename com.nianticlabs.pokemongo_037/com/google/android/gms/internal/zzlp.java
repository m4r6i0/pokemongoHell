...
public class zzlp extends Fragment implements OnCancelListener {
    ...
    private class zzb implements Runnable {
        ...
        class C05881 extends zzll {
            final /* synthetic */ Dialog zzacW;
            final /* synthetic */ zzb zzacX;

            C05881(zzb com_google_android_gms_internal_zzlp_zzb, Dialog dialog) {
        ...
        public void run() {
            if (this.zzacT.mStarted && !this.zzacT.zzacK) {
                ...
                if (this.zzacV.hasResolution()) {
                    ...
                    this.zzacT.zzacO = zzll.zza(this.zzacT.getActivity().getApplicationContext(), new C05881(this, zzlp.zzacJ.zza(this.zzacT.getActivity(), this.zzacT)));
                } else {
