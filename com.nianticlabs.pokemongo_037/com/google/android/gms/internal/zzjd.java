...
class zzjd extends WebView implements OnGlobalLayoutListener, DownloadListener, zziz {
    ...
    class C05631 implements Runnable {
        ...
        C05631(zzjd com_google_android_gms_internal_zzjd) {
    ...
    public void destroy() {
        synchronized (this.zzpd) {
            ...
            zzhC();
            this.zzKq = true;
            zzb.m41v("Initiating WebView self destruct sequence in 3...");
            this.zzKn.zzhs();
        }
    }
    ...
    public void zzb(String str, JSONObject jSONObject) {
        ...
        stringBuilder.append(");");
        zzb.m41v("Dispatching AFMA event: " + stringBuilder.toString());
    ...
    public void zzhj() {
        synchronized (this.zzpd) {
            zzb.m41v("Destroying WebView!");
            zzid.zzIE.post(new C05631(this));
        }
    }
