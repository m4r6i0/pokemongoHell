...
public class zzja extends WebViewClient {
    ...
    class C05621 implements Runnable {
        ...
        C05621(zzja com_google_android_gms_internal_zzja) {
    ...
    public final void onLoadResource(android.webkit.WebView webView, String url) {
        com.google.android.gms.ads.internal.util.client.zzb.m41v("Loading resource: " + url);
    ...
    public final void onPageFinished(android.webkit.WebView webView, String url) {
        synchronized (this.zzpd) {
            if (this.zzKe && "about:blank".equals(url)) {
                com.google.android.gms.ads.internal.util.client.zzb.m41v("Blank page loaded, 1...");
                this.zzoM.zzhj();
                return;
            }
            this.zzKf = true;
    ...
    public final boolean shouldOverrideUrlLoading(android.webkit.WebView webView, String url) {
        com.google.android.gms.ads.internal.util.client.zzb.m41v("AdWebView shouldOverrideUrlLoading: " + url);
        Uri parse = Uri.parse(url);
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            zzh(parse);
    ...
    public final void zzeG() {
        synchronized (this.zzpd) {
            this.zzJZ = false;
            this.zzqW = true;
            zzid.runOnUiThread(new C05621(this));
        }
    }
    ...
    public void zzh(Uri uri) {
        ...
        if (list != null) {
            ...
            if (com.google.android.gms.ads.internal.util.client.zzb.zzN(2)) {
                com.google.android.gms.ads.internal.util.client.zzb.m41v("Received GMSG: " + path);
                for (String path2 : zze.keySet()) {
                    com.google.android.gms.ads.internal.util.client.zzb.m41v("  " + path2 + ": " + ((String) zze.get(path2)));
                }
            }
            for (zzdk zza : list) {
        ...
        com.google.android.gms.ads.internal.util.client.zzb.m41v("No GMSG handler found for GMSG: " + uri);
    }
    ...
    public void zzhs() {
        synchronized (this.zzpd) {
            com.google.android.gms.ads.internal.util.client.zzb.m41v("Loading blank page in WebView, 2...");
            this.zzKe = true;
