...
public class zzaz implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C04321 implements zzc<zzbe> {
        final /* synthetic */ JSONObject zzrv;
        final /* synthetic */ zzaz zzrw;

        C04321(zzaz com_google_android_gms_internal_zzaz, JSONObject jSONObject) {
    ...
    class C04332 implements zza {
        final /* synthetic */ zzaz zzrw;

        C04332(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04343 implements zzc<zzbe> {
        final /* synthetic */ zzaz zzrw;

        C04343(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04354 implements zza {
        final /* synthetic */ zzaz zzrw;

        C04354(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04365 extends BroadcastReceiver {
        final /* synthetic */ zzaz zzrw;

        C04365(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04376 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C04376(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04387 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C04387(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04398 implements zzdk {
        final /* synthetic */ zzaz zzrw;

        C04398(zzaz com_google_android_gms_internal_zzaz) {
            this.zzrw = com_google_android_gms_internal_zzaz;
        }
    ...
    class C04409 implements zzc<zzbe> {
        final /* synthetic */ zzaz zzrw;
        final /* synthetic */ JSONObject zzrx;

        C04409(zzaz com_google_android_gms_internal_zzaz, JSONObject jSONObject) {
            this.zzrw = com_google_android_gms_internal_zzaz;
    ...
    public zzaz(AdSizeParcel adSizeParcel, zzhs com_google_android_gms_internal_zzhs, VersionInfoParcel versionInfoParcel, View view, zzdz com_google_android_gms_internal_zzdz) {
        ...
        this.zzrs = new C04376(this);
        this.zzrt = new C04387(this);
        this.zzru = new C04398(this);
        ...
        try {
            this.zzrg.zza(new C04321(this, zzd(view)), new C04332(this));
        } catch (JSONException e) {
        } catch (Throwable e2) {
            zzb.zzb("Failure while processing active view data.", e2);
        }
        this.zzrg.zza(new C04343(this), new C04354(this));
    ...
    protected void zza(JSONObject jSONObject) {
        try {
            ...
            this.zzrg.zza(new C04409(this, jSONObject2), new zzis.zzb());
        } catch (Throwable th) {
