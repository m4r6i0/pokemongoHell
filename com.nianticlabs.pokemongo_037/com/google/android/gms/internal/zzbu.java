...
public abstract class zzbu<T> {
    ...
    static class C04541 extends zzbu<Boolean> {
        C04541(String str, Boolean bool) {
            super(bool, null);
        }
    ...
    static class C04552 extends zzbu<Integer> {
        C04552(String str, Integer num) {
            super(num, null);
        }
    ...
    static class C04563 extends zzbu<Long> {
        C04563(String str, Long l) {
            super(l, null);
        }
    ...
    static class C04574 extends zzbu<String> {
        C04574(String str, String str2) {
            super(str2, null);
        }
