...
public class zzfb extends zzfh {
    ...
    class C05081 implements OnClickListener {
        ...
        C05081(zzfb com_google_android_gms_internal_zzfb) {
    ...
    class C05092 implements OnClickListener {
        ...
        C05092(zzfb com_google_android_gms_internal_zzfb) {
            this.zzAa = com_google_android_gms_internal_zzfb;
        }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzK.setTitle(zzp.zzby().zzd(C0138R.string.create_calendar_title, "Create calendar event"));
            zzK.setMessage(zzp.zzby().zzd(C0138R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzK.setPositiveButton(zzp.zzby().zzd(C0138R.string.accept, "Accept"), new C05081(this));
            zzK.setNegativeButton(zzp.zzby().zzd(C0138R.string.decline, "Decline"), new C05092(this));
            zzK.create().show();
        } else {
