...
public abstract class zzlr<T> {
    ...
    static class C05891 extends zzlr<Boolean> {
        C05891(String str, Boolean bool) {
            super(str, bool);
        }
    ...
    static class C05902 extends zzlr<Long> {
        C05902(String str, Long l) {
            super(str, l);
        }
    ...
    static class C05913 extends zzlr<Integer> {
        C05913(String str, Integer num) {
            super(str, num);
        }
    ...
    static class C05924 extends zzlr<Float> {
        C05924(String str, Float f) {
            super(str, f);
        }
    ...
    static class C05935 extends zzlr<String> {
        C05935(String str, String str2) {
            super(str, str2);
        }
