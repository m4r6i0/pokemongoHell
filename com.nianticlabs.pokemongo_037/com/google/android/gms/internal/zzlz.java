...
public final class zzlz implements zzly {
    ...
    class C05961 extends zza {
        final /* synthetic */ zzlz zzagx;

        C05961(zzlz com_google_android_gms_internal_zzlz, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzb(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C05961(this, googleApiClient));
    }
}
