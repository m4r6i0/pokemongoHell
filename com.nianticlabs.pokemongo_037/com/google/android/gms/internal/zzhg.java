...
public class zzhg extends zzb implements zzhk {
    ...
    class C05351 implements Runnable {
        ...
        C05351(zzhg com_google_android_gms_internal_zzhg, zza com_google_android_gms_internal_zzhs_zza) {
    ...
    public void zza(zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
        if (com_google_android_gms_internal_zzhs_zza.errorCode != -2) {
            zzid.zzIE.post(new C05351(this, com_google_android_gms_internal_zzhs_zza));
            return;
        }
        this.zzot.zzqH = 0;
