...
public final class zzli extends GoogleApiClient {
    ...
    class C05791 implements zze {
        final /* synthetic */ zzli zzacr;

        C05791(zzli com_google_android_gms_internal_zzli) {
    ...
    class C05802 implements ConnectionCallbacks {
        final /* synthetic */ zzli zzacr;

        C05802(zzli com_google_android_gms_internal_zzli) {
            this.zzacr = com_google_android_gms_internal_zzli;
        }
    ...
    class C05813 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzli zzacr;

        C05813(zzli com_google_android_gms_internal_zzli) {
            this.zzacr = com_google_android_gms_internal_zzli;
        }
    ...
    class C05824 implements OnConnectionFailedListener {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ Api zzacs;
        final /* synthetic */ int zzact;

        C05824(zzli com_google_android_gms_internal_zzli, Api api, int i) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacs = api;
            this.zzact = i;
        }
    ...
    class C05835 implements ConnectionCallbacks {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ AtomicReference zzacu;
        final /* synthetic */ zzlo zzacv;

        C05835(zzli com_google_android_gms_internal_zzli, AtomicReference atomicReference, zzlo com_google_android_gms_internal_zzlo) {
            this.zzacr = com_google_android_gms_internal_zzli;
    ...
    class C05846 implements OnConnectionFailedListener {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ zzlo zzacv;

        C05846(zzli com_google_android_gms_internal_zzli, zzlo com_google_android_gms_internal_zzlo) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacv = com_google_android_gms_internal_zzlo;
        }
    ...
    class C05857 implements ResultCallback<Status> {
        final /* synthetic */ GoogleApiClient zzWT;
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ zzlo zzacv;
        final /* synthetic */ boolean zzacw;

        C05857(zzli com_google_android_gms_internal_zzli, zzlo com_google_android_gms_internal_zzlo, boolean z, GoogleApiClient googleApiClient) {
            this.zzacr = com_google_android_gms_internal_zzli;
            this.zzacv = com_google_android_gms_internal_zzlo;
            this.zzacw = z;
    ...
    class C05868 implements Runnable {
        final /* synthetic */ zzli zzacr;
        final /* synthetic */ FragmentActivity zzacx;

        C05868(zzli com_google_android_gms_internal_zzli, FragmentActivity fragmentActivity) {
            this.zzacr = com_google_android_gms_internal_zzli;
    ...
    public zzli(Context context, Looper looper, com.google.android.gms.common.internal.zzf com_google_android_gms_common_internal_zzf, GoogleApiAvailability googleApiAvailability, com.google.android.gms.common.api.Api.zza<? extends zzqw, zzqx> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzqw__com_google_android_gms_internal_zzqx, Map<Api<?>, ApiOptions> map, ArrayList<ConnectionCallbacks> arrayList, ArrayList<OnConnectionFailedListener> arrayList2, int i) {
        ...
        this.zzaco = new C05791(this);
        this.zzacp = new C05802(this);
        this.zzacq = new C05813(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzlo com_google_android_gms_internal_zzlo, boolean z) {
        zzlx.zzagw.zzb(googleApiClient).setResultCallback(new C05857(this, com_google_android_gms_internal_zzlo, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zzacg.containsKey(zzlx.zzRk)) {
            ...
            ConnectionCallbacks c05835 = new C05835(this, atomicReference, com_google_android_gms_internal_zzlo);
            GoogleApiClient build = new Builder(this.mContext).addApi(zzlx.API).addConnectionCallbacks(c05835).addOnConnectionFailedListener(new C05846(this, com_google_android_gms_internal_zzlo)).setHandler(this.zzace).build();
    ...
    public void stopAutoManage(FragmentActivity lifecycleActivity) {
        if (this.zzaaM >= 0) {
            ...
            if (zza == null) {
                new Handler(this.mContext.getMainLooper()).post(new C05868(this, lifecycleActivity));
                return;
            } else {
                zza.zzbp(this.zzaaM);
                return;
