...
public class zzff {
    ...
    public JSONObject toJson() {
        try {
            return new JSONObject().put(Sharing.SMS, this.zzAv).put(MRAIDNativeFeature.TEL, this.zzAw).put(MRAIDNativeFeature.CALENDAR, this.zzAx).put(MRAIDNativeFeature.STORE_PICTURE, this.zzAy).put(MRAIDNativeFeature.INLINE_VIDEO, this.zzAz);
        } catch (Throwable e) {
