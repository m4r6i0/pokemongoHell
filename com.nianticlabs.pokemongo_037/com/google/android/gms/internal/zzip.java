...
public class zzip {
    ...
    static class C05601 implements Runnable {
        final /* synthetic */ zzin zzJB;
        final /* synthetic */ zza zzJC;
        final /* synthetic */ zziq zzJD;

        C05601(zzin com_google_android_gms_internal_zzin, zza com_google_android_gms_internal_zzip_zza, zziq com_google_android_gms_internal_zziq) {
    ...
    static class C05612 implements Runnable {
        final /* synthetic */ AtomicInteger zzJE;
        final /* synthetic */ int zzJF;
        final /* synthetic */ zzin zzJG;
        final /* synthetic */ List zzJH;

        C05612(AtomicInteger atomicInteger, int i, zzin com_google_android_gms_internal_zzin, List list) {
    ...
    public static <A, B> zziq<B> zza(zziq<A> com_google_android_gms_internal_zziq_A, zza<A, B> com_google_android_gms_internal_zzip_zza_A__B) {
        ...
        com_google_android_gms_internal_zziq_A.zzc(new C05601(com_google_android_gms_internal_zzin, com_google_android_gms_internal_zzip_zza_A__B, com_google_android_gms_internal_zziq_A));
    ...
    public static <V> zziq<List<V>> zzh(List<zziq<V>> list) {
        ...
        for (zziq zzc : list) {
            zzc.zzc(new C05612(atomicInteger, size, com_google_android_gms_internal_zzin, list));
        }
        return com_google_android_gms_internal_zzin;
    }
