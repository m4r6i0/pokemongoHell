...
public class zzhi extends zzhz implements zzhj, zzhm {
    ...
    class C05361 implements Runnable {
        ...
        C05361(zzhi com_google_android_gms_internal_zzhi, zzen com_google_android_gms_internal_zzen, AdRequestParcel adRequestParcel) {
    ...
    class C05372 implements Runnable {
        ...
        C05372(zzhi com_google_android_gms_internal_zzhi, zzen com_google_android_gms_internal_zzen, AdRequestParcel adRequestParcel, zzhl com_google_android_gms_internal_zzhl) {
            this.zzHl = com_google_android_gms_internal_zzhi;
            this.zzHk = com_google_android_gms_internal_zzen;
            this.zzpe = adRequestParcel;
        ...
        if (this.zzHg != null && this.zzHg.zzgd() != null && this.zzHg.zzgc() != null) {
            ...
            try {
                if (zzgc.isInitialized()) {
                    com.google.android.gms.ads.internal.util.client.zza.zzJt.post(new C05361(this, zzgc, adRequestParcel));
                } else {
                    com.google.android.gms.ads.internal.util.client.zza.zzJt.post(new C05372(this, zzgc, adRequestParcel, zzgd));
                }
            } catch (Throwable e) {
