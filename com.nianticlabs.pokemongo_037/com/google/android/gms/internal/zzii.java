...
public class zzii {
    ...
    class C05591 implements Runnable {
        ...
        C05591(zzii com_google_android_gms_internal_zzii) {
        ...
        public void run() {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.m41v(r0);	 Catch:{ all -> 0x002a }
        L_0x000c:
        ...
        L_0x0014:
            ...
            com.google.android.gms.ads.internal.util.client.zzb.m41v(r0);	 Catch:{ InterruptedException -> 0x0023 }
            goto L_0x000c;
        L_0x0023:
            r0 = move-exception;
    ...
    public Looper zzgM() {
        ...
        synchronized (this.zzpd) {
            if (this.zzJi != 0) {
                ...
                zzb.m41v("Starting the looper thread.");
                this.zzJh = new HandlerThread("LooperProvider");
                this.zzJh.start();
                this.mHandler = new Handler(this.zzJh.getLooper());
                zzb.m41v("Looper thread started.");
            } else {
                zzb.m41v("Resuming the looper thread");
                this.zzpd.notifyAll();
            }
            this.zzJi++;
    ...
    public void zzgN() {
        synchronized (this.zzpd) {
            ...
            this.zzJi = i;
            if (i == 0) {
                this.mHandler.post(new C05591(this));
            }
        }
    }
}
