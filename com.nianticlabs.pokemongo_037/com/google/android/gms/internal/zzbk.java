...
public class zzbk extends Thread {
    ...
    class C04491 implements Runnable {
        ...
        C04491(zzbk com_google_android_gms_internal_zzbk, View view) {
    ...
    class C04512 implements Runnable {
        ...
        class C04501 implements ValueCallback<String> {
            final /* synthetic */ C04512 zzsl;
        ...
        C04512(zzbk com_google_android_gms_internal_zzbk, zzbh com_google_android_gms_internal_zzbh, WebView webView) {
            this.zzsh = com_google_android_gms_internal_zzbk;
            this.zzsj = com_google_android_gms_internal_zzbh;
            this.zzsk = webView;
            this.zzsi = new C04501(this);
        }
    ...
    boolean zza(WebView webView, zzbh com_google_android_gms_internal_zzbh) {
        ...
        com_google_android_gms_internal_zzbh.zzcp();
        webView.post(new C04512(this, com_google_android_gms_internal_zzbh, webView));
        return true;
    }
    ...
    boolean zzf(View view) {
        ...
        view.post(new C04491(this, view));
        return true;
    }
