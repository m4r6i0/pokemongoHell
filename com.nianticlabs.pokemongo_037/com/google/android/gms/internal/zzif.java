...
public class zzif {
    ...
    class C05521 implements OnClickListener {
        ...
        C05521(zzif com_google_android_gms_internal_zzif, String str) {
    ...
    class C05532 implements OnClickListener {
        ...
        C05532(zzif com_google_android_gms_internal_zzif) {
            this.zzIN = com_google_android_gms_internal_zzif;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C05521(this, zzaD));
            builder.setNegativeButton("Close", new C05532(this));
            builder.create().show();
            return;
        }
