...
public class zzgm implements Callable<zzhs> {
    ...
    class C05201 implements zzdk {
        final /* synthetic */ zzbb zzDK;
        final /* synthetic */ zzb zzDL;
        final /* synthetic */ zzin zzDM;
        final /* synthetic */ zzgm zzDN;

        C05201(zzgm com_google_android_gms_internal_zzgm, zzbb com_google_android_gms_internal_zzbb, zzb com_google_android_gms_internal_zzgm_zzb, zzin com_google_android_gms_internal_zzin) {
    ...
    class C05212 implements Runnable {
        ...
        C05212(zzgm com_google_android_gms_internal_zzgm, zzin com_google_android_gms_internal_zzin, String str) {
            this.zzDN = com_google_android_gms_internal_zzgm;
    ...
    class C05223 implements zzdk {
        final /* synthetic */ zzgm zzDN;
        final /* synthetic */ zzf zzDQ;

        C05223(zzgm com_google_android_gms_internal_zzgm, zzf com_google_android_gms_ads_internal_formats_zzf) {
            this.zzDN = com_google_android_gms_internal_zzgm;
    ...
    class C05234 implements com.google.android.gms.internal.zzip.zza<List<zzc>, com.google.android.gms.ads.internal.formats.zza> {
        final /* synthetic */ zzgm zzDN;
        ...
        C05234(zzgm com_google_android_gms_internal_zzgm, String str, Integer num, Integer num2, int i, int i2, int i3) {
            this.zzDN = com_google_android_gms_internal_zzgm;
            this.zzDR = str;
            this.zzDS = num;
            this.zzDT = num2;
    ...
    class C05245 implements com.google.android.gms.internal.zzih.zza<zzc> {
        final /* synthetic */ String zzAs;
        final /* synthetic */ zzgm zzDN;
        final /* synthetic */ boolean zzDX;
        final /* synthetic */ double zzDY;

        C05245(zzgm com_google_android_gms_internal_zzgm, boolean z, double d, String str) {
            this.zzDN = com_google_android_gms_internal_zzgm;
            this.zzDX = z;
            this.zzDY = d;
            this.zzAs = str;
    ...
    private com.google.android.gms.ads.internal.formats.zzh.zza zza(zzbb com_google_android_gms_internal_zzbb, zza com_google_android_gms_internal_zzgm_zza, JSONObject jSONObject) throws ExecutionException, InterruptedException, JSONException {
        ...
        if (zza == null) {
            com.google.android.gms.ads.internal.util.client.zzb.m40e("Failed to retrieve ad assets.");
            return null;
        }
    ...
    private zziq<zzc> zza(JSONObject jSONObject, boolean z, boolean z2) throws JSONException {
        ...
        if (!TextUtils.isEmpty(string)) {
            return z2 ? new zzio(new zzc(null, Uri.parse(string), optDouble)) : this.zzDF.zza(string, new C05245(this, z, optDouble, string));
        } else {
            zza(0, z);
    ...
    private void zza(com.google.android.gms.ads.internal.formats.zzh.zza com_google_android_gms_ads_internal_formats_zzh_zza, zzbb com_google_android_gms_internal_zzbb) {
        if (com_google_android_gms_ads_internal_formats_zzh_zza instanceof zzf) {
            ...
            zzdk c05223 = new C05223(this, com_google_android_gms_ads_internal_formats_zzf);
            com_google_android_gms_internal_zzgm_zzb.zzDZ = c05223;
            com_google_android_gms_internal_zzbb.zza("/nativeAdCustomClick", c05223);
        }
    }
    ...
    private JSONObject zzb(zzbb com_google_android_gms_internal_zzbb) throws TimeoutException, JSONException {
        ...
        zzb com_google_android_gms_internal_zzgm_zzb = new zzb(this);
        zzdk c05201 = new C05201(this, com_google_android_gms_internal_zzbb, com_google_android_gms_internal_zzgm_zzb, com_google_android_gms_internal_zzin);
        com_google_android_gms_internal_zzgm_zzb.zzDZ = c05201;
        com_google_android_gms_internal_zzbb.zza("/nativeAdPreProcess", c05201);
    ...
    protected zza zzd(JSONObject jSONObject) throws JSONException, TimeoutException {
        ...
        if ("3".equals(string)) {
            ...
            zzin com_google_android_gms_internal_zzin = new zzin();
            zzid.zzIE.post(new C05212(this, com_google_android_gms_internal_zzin, string2));
            if (com_google_android_gms_internal_zzin.get(zzDE, TimeUnit.MILLISECONDS) != null) {
                return new zzgp(z);
            }
            com.google.android.gms.ads.internal.util.client.zzb.m40e("No handler for custom template: " + jSONObject.getString("custom_template_id"));
        } else {
            zzC(0);
        }
        return null;
    ...
    public zziq<com.google.android.gms.ads.internal.formats.zza> zze(JSONObject jSONObject) throws JSONException {
        ...
        return zzip.zza(zzip.zzh(arrayList), new C05234(this, optString, zzb2, zzb, optInt, optInt3, optInt2));
    }
