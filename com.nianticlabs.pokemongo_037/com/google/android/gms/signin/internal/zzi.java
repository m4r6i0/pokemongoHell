...
public class zzi extends zzj<zzf> implements zzqw {
    ...
    private static class zza extends com.google.android.gms.signin.internal.zzd.zza {
        ...
        class C06511 implements Runnable {
            ...
            C06511(zza com_google_android_gms_signin_internal_zzi_zza, List list, String str, zzf com_google_android_gms_signin_internal_zzf) {
        ...
        class C06522 implements Runnable {
            ...
            C06522(zza com_google_android_gms_signin_internal_zzi_zza, String str, String str2, zzf com_google_android_gms_signin_internal_zzf) {
                this.zzaVq = com_google_android_gms_signin_internal_zzi_zza;
                this.zzaVo = str;
                this.zzaVr = str2;
                this.zzaVp = com_google_android_gms_signin_internal_zzf;
        ...
        public void zza(String str, String str2, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaVm.submit(new C06522(this, str, str2, com_google_android_gms_signin_internal_zzf));
        }

        public void zza(String str, List<Scope> list, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaVm.submit(new C06511(this, list, str, com_google_android_gms_signin_internal_zzf));
        }
    }
