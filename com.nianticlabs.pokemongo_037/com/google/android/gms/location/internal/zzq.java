...
public class zzq implements SettingsApi {
    ...
    class C06361 extends zza<LocationSettingsResult> {
        final /* synthetic */ LocationSettingsRequest zzaFP;
        final /* synthetic */ String zzaFQ;
        final /* synthetic */ zzq zzaFR;

        C06361(zzq com_google_android_gms_location_internal_zzq, GoogleApiClient googleApiClient, LocationSettingsRequest locationSettingsRequest, String str) {
    ...
    public PendingResult<LocationSettingsResult> zza(GoogleApiClient googleApiClient, LocationSettingsRequest locationSettingsRequest, String str) {
        return googleApiClient.zza(new C06361(this, googleApiClient, locationSettingsRequest, str));
    }
}
