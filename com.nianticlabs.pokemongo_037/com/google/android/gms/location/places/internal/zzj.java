...
public class zzj implements PlaceDetectionApi {
    ...
    class C06431 extends zzd<zzk> {
        final /* synthetic */ PlaceFilter zzaHf;
        final /* synthetic */ zzj zzaHg;

        C06431(zzj com_google_android_gms_location_places_internal_zzj, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, PlaceFilter placeFilter) {
    ...
    class C06442 extends zzf<zzk> {
        final /* synthetic */ zzj zzaHg;
        final /* synthetic */ PlaceReport zzaHh;

        C06442(zzj com_google_android_gms_location_places_internal_zzj, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, PlaceReport placeReport) {
            this.zzaHg = com_google_android_gms_location_places_internal_zzj;
    ...
    public PendingResult<PlaceLikelihoodBuffer> getCurrentPlace(GoogleApiClient client, PlaceFilter filter) {
        return client.zza(new C06431(this, Places.zzaGA, client, filter));
    }

    public PendingResult<Status> reportDeviceAtPlace(GoogleApiClient client, PlaceReport report) {
        return client.zzb(new C06442(this, Places.zzaGA, client, report));
    }
}
