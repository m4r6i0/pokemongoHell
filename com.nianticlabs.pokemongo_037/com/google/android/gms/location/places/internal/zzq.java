...
public class zzq implements PlacePhotoMetadata {
    ...
    class C06461 extends zza<zze> {
        final /* synthetic */ int zzaHN;
        final /* synthetic */ int zzaHO;
        final /* synthetic */ zzq zzaHP;

        C06461(zzq com_google_android_gms_location_places_internal_zzq, zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, int i, int i2) {
    ...
    public PendingResult<PlacePhotoResult> getScaledPhoto(GoogleApiClient client, int width, int height) {
        return client.zza(new C06461(this, Places.zzaGz, client, width, height));
    }
