...
public class zzd implements GeoDataApi {
    ...
    class C06391 extends zzc<zze> {
        final /* synthetic */ AddPlaceRequest zzaGV;
        final /* synthetic */ zzd zzaGW;

        C06391(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, AddPlaceRequest addPlaceRequest) {
    ...
    class C06402 extends zzc<zze> {
        final /* synthetic */ zzd zzaGW;
        final /* synthetic */ String[] zzaGX;

        C06402(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String[] strArr) {
            this.zzaGW = com_google_android_gms_location_places_internal_zzd;
            this.zzaGX = strArr;
            super(com_google_android_gms_common_api_Api_zzc, googleApiClient);
        }
    ...
    class C06413 extends zza<zze> {
        final /* synthetic */ zzd zzaGW;
        final /* synthetic */ LatLngBounds zzaGY;
        final /* synthetic */ AutocompleteFilter zzaGZ;
        final /* synthetic */ String zzaxk;

        C06413(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String str, LatLngBounds latLngBounds, AutocompleteFilter autocompleteFilter) {
            this.zzaGW = com_google_android_gms_location_places_internal_zzd;
            this.zzaxk = str;
    ...
    class C06424 extends zzb<zze> {
        final /* synthetic */ zzd zzaGW;
        final /* synthetic */ String zzaHa;

        C06424(zzd com_google_android_gms_location_places_internal_zzd, Api.zzc com_google_android_gms_common_api_Api_zzc, GoogleApiClient googleApiClient, String str) {
            this.zzaGW = com_google_android_gms_location_places_internal_zzd;
            this.zzaHa = str;
            super(com_google_android_gms_common_api_Api_zzc, googleApiClient);
        }
    ...
    public PendingResult<PlaceBuffer> addPlace(GoogleApiClient client, AddPlaceRequest addPlaceRequest) {
        return client.zzb(new C06391(this, Places.zzaGz, client, addPlaceRequest));
    }
    ...
    public PendingResult<AutocompletePredictionBuffer> getAutocompletePredictions(GoogleApiClient client, String query, LatLngBounds bounds, AutocompleteFilter filter) {
        return client.zza(new C06413(this, Places.zzaGz, client, query, bounds, filter));
    }
    ...
    public PendingResult<PlaceBuffer> getPlaceById(GoogleApiClient client, String... placeIds) {
        ...
        zzx.zzaa(z);
        return client.zza(new C06402(this, Places.zzaGz, client, placeIds));
    }

    public PendingResult<PlacePhotoMetadataResult> getPlacePhotos(GoogleApiClient client, String placeId) {
        return client.zza(new C06424(this, Places.zzaGz, client, placeId));
    }
}
