...
public class GoogleApiAvailability {
    ...
    public Dialog zza(Activity activity, OnCancelListener onCancelListener) {
        ...
        builder.setMessage(activity.getResources().getString(C0138R.string.common_google_play_services_updating_text, new Object[]{zzaf}));
        builder.setTitle(C0138R.string.common_google_play_services_updating_title);
