...
public final class GooglePlayServicesUtil {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0138R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
    ...
    private static void zza(int i, Context context, String str) {
        ...
        if (zzi == null) {
            zzi = resources.getString(C0138R.string.common_google_play_services_notification_ticker);
        }
        ...
        if (zzml.zzan(context)) {
            zzx.zzZ(zzmx.zzqy());
            build = new Notification.Builder(context).setSmallIcon(C0138R.drawable.common_ic_googleplayservices).setPriority(2).setAutoCancel(true).setStyle(new BigTextStyle().bigText(zzi + " " + zzd)).addAction(C0138R.drawable.common_full_open_on_phone, resources.getString(C0138R.string.common_open_on_phone), zza).build();
        } else {
            CharSequence string = resources.getString(C0138R.string.common_google_play_services_notification_ticker);
            if (zzmx.zzqu()) {
                Notification build2;
