...
public final class zzab extends Button {
    ...
    private void zzb(Resources resources, int i, int i2) {
        ...
        switch (i) {
            ...
            case C1562R.styleable.LoadingImageView_imageAspectRatio /*1*/:
                zzd = zzd(i2, C0138R.drawable.common_signin_btn_text_dark, C0138R.drawable.common_signin_btn_text_light);
                break;
            case C1562R.styleable.LoadingImageView_circleCrop /*2*/:
                zzd = zzd(i2, C0138R.drawable.common_signin_btn_icon_dark, C0138R.drawable.common_signin_btn_icon_light);
                break;
            default:
    ...
    private void zzc(Resources resources, int i, int i2) {
        setTextColor(resources.getColorStateList(zzd(i2, C0138R.color.common_signin_btn_text_dark, C0138R.color.common_signin_btn_text_light)));
        switch (i) {
            case C1562R.styleable.AdsAttrs_adSize /*0*/:
                setText(resources.getString(C0138R.string.common_signin_button_text));
            case C1562R.styleable.LoadingImageView_imageAspectRatio /*1*/:
                setText(resources.getString(C0138R.string.common_signin_button_text_long));
            case C1562R.styleable.LoadingImageView_circleCrop /*2*/:
                setText(null);
            default:
                throw new IllegalStateException("Unknown button size: " + i);
