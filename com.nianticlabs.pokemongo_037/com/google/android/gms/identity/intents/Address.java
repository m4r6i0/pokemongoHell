...
public final class Address {
    ...
    static class C04241 extends com.google.android.gms.common.api.Api.zza<zzoy, AddressOptions> {
        C04241() {
        }
    ...
    static class C04252 extends zza {
        final /* synthetic */ UserAddressRequest zzaDf;
        final /* synthetic */ int zzaDg;

        C04252(GoogleApiClient googleApiClient, UserAddressRequest userAddressRequest, int i) {
    ...
    public static void requestUserAddress(GoogleApiClient googleApiClient, UserAddressRequest request, int requestCode) {
        googleApiClient.zza(new C04252(googleApiClient, request, requestCode));
    }
}
