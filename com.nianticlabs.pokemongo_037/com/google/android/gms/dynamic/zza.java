...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    class C04081 implements zzf<T> {
        final /* synthetic */ zza zzapr;

        C04081(zza com_google_android_gms_dynamic_zza) {
    ...
    class C04092 implements zza {
        final /* synthetic */ zza zzapr;
        final /* synthetic */ Activity zzaps;
        final /* synthetic */ Bundle zzapt;
        final /* synthetic */ Bundle zzapu;

        C04092(zza com_google_android_gms_dynamic_zza, Activity activity, Bundle bundle, Bundle bundle2) {
            this.zzapr = com_google_android_gms_dynamic_zza;
            this.zzaps = activity;
            this.zzapt = bundle;
            this.zzapu = bundle2;
    ...
    class C04103 implements zza {
        final /* synthetic */ zza zzapr;
        final /* synthetic */ Bundle zzapu;

        C04103(zza com_google_android_gms_dynamic_zza, Bundle bundle) {
            this.zzapr = com_google_android_gms_dynamic_zza;
            this.zzapu = bundle;
        }
    ...
    class C04114 implements zza {
        ...
        C04114(zza com_google_android_gms_dynamic_zza, FrameLayout frameLayout, LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
            this.zzapr = com_google_android_gms_dynamic_zza;
    ...
    static class C04125 implements OnClickListener {
        final /* synthetic */ int zzapy;
        final /* synthetic */ Context zzry;

        C04125(Context context, int i) {
            this.zzry = context;
            this.zzapy = i;
        }
    ...
    class C04136 implements zza {
        final /* synthetic */ zza zzapr;

        C04136(zza com_google_android_gms_dynamic_zza) {
            this.zzapr = com_google_android_gms_dynamic_zza;
        }
    ...
    class C04147 implements zza {
        final /* synthetic */ zza zzapr;

        C04147(zza com_google_android_gms_dynamic_zza) {
            this.zzapr = com_google_android_gms_dynamic_zza;
        }
    ...
    public static void zzb(FrameLayout frameLayout) {
        ...
        if (zzh != null) {
            ...
            button.setOnClickListener(new C04125(context, isGooglePlayServicesAvailable));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        zza(savedInstanceState, new C04103(this, savedInstanceState));
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        FrameLayout frameLayout = new FrameLayout(inflater.getContext());
        zza(savedInstanceState, new C04114(this, frameLayout, inflater, container, savedInstanceState));
        if (this.zzapn == null) {
            zza(frameLayout);
        }
        return frameLayout;
    ...
    public void onInflate(Activity activity, Bundle attrs, Bundle savedInstanceState) {
        zza(savedInstanceState, new C04092(this, activity, attrs, savedInstanceState));
    }
