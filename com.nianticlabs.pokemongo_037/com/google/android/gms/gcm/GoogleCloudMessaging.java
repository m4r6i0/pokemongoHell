...
public class GoogleCloudMessaging {
    ...
    class C04171 extends Handler {
        final /* synthetic */ GoogleCloudMessaging zzaCB;

        C04171(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzaCA = new Messenger(new C04171(this, Looper.getMainLooper()));
    }
