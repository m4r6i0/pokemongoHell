...
public abstract class GcmListenerService extends Service {
    ...
    class C04151 implements Runnable {
        ...
        C04151(GcmListenerService gcmListenerService, Intent intent) {
    ...
    class C04162 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzaCg;

        C04162(GcmListenerService gcmListenerService, Intent intent) {
            this.zzaCg = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    public final int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C04151(this, intent));
        } else {
            new C04162(this, intent).execute(new Void[0]);
        }
        return 3;
    }
