...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C01501 implements Runnable {
        ...
        C01501(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C01512 implements Runnable {
        ...
        C01512(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01523 implements Runnable {
        ...
        C01523(zzc com_google_android_gms_ads_internal_overlay_zzc, String str, String str2) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
            this.zzBf = str;
            this.zzBg = str2;
        }
    ...
    class C01534 implements Runnable {
        ...
        C01534(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01545 implements Runnable {
        ...
        C01545(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01556 implements Runnable {
        ...
        C01556(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C01567 implements Runnable {
        ...
        C01567(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzBe = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    private void zzeA() {
        zzb.m41v("AdMediaPlayerView audio focus lost");
        this.zzBb = false;
        zzeB();
    }
    ...
    private void zzes() {
        Throwable e;
        zzb.m41v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzet() {
        if (zzew() && this.zzAS.getCurrentPosition() > 0 && this.zzAR != 3) {
            zzb.m41v("AdMediaPlayerView nudging MediaPlayer");
            zzb(0.0f);
            this.zzAS.start();
    ...
    private void zzev() {
        zzb.m41v("AdMediaPlayerView abandon audio focus");
        AudioManager zzeC = zzeC();
        if (zzeC != null && this.zzBb) {
    ...
    private void zzez() {
        zzb.m41v("AdMediaPlayerView audio focus gained");
        this.zzBb = true;
        zzeB();
    }
    ...
    private void zzt(boolean z) {
        zzb.m41v("AdMediaPlayerView release");
        if (this.zzAS != null) {
            this.zzAS.reset();
            this.zzAS.release();
            this.zzAS = null;
    ...
    public void onCompletion(MediaPlayer mp) {
        zzb.m41v("AdMediaPlayerView completion");
        zzt(5);
        zzu(5);
        zzid.zzIE.post(new C01512(this));
    }
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        zzt(-1);
        zzu(-1);
        zzid.zzIE.post(new C01523(this, str, str2));
        return true;
    }

    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        String str = (String) zzAO.get(Integer.valueOf(extra));
        zzb.m41v("AdMediaPlayerView MediaPlayer info: " + ((String) zzAO.get(Integer.valueOf(what))) + UpsightEndpoint.SIGNED_MESSAGE_SEPARATOR + str);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzb.m41v("AdMediaPlayerView prepared");
        zzt(2);
        this.zzAP.zzeR();
        zzid.zzIE.post(new C01501(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        zzb.m41v("AdMediaPlayerView surface created");
        zzes();
        zzid.zzIE.post(new C01534(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        zzb.m41v("AdMediaPlayerView surface destroyed");
        if (this.zzAS != null && this.zzBc == 0) {
            this.zzBc = this.zzAS.getCurrentPosition();
        }
        zzid.zzIE.post(new C01545(this));
        zzt(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int w, int h) {
        Object obj = 1;
        zzb.m41v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        zzb.m41v("AdMediaPlayerView size changed: " + width + " x " + height);
    ...
    public void pause() {
        zzb.m41v("AdMediaPlayerView pause");
        if (zzew() && this.zzAS.isPlaying()) {
            this.zzAS.pause();
            zzt(4);
            zzid.zzIE.post(new C01567(this));
        }
        zzu(4);
    }

    public void play() {
        zzb.m41v("AdMediaPlayerView play");
        if (zzew()) {
            this.zzAS.start();
            zzt(3);
            zzid.zzIE.post(new C01556(this));
        }
        zzu(3);
    }

    public void seekTo(int millis) {
        zzb.m41v("AdMediaPlayerView seek " + millis);
        if (zzew()) {
    ...
    public void stop() {
        zzb.m41v("AdMediaPlayerView stop");
        if (this.zzAS != null) {
            this.zzAS.stop();
            this.zzAS.release();
            this.zzAS = null;
