...
public class zzd extends com.google.android.gms.internal.zzfk.zza implements zzo {
    ...
    class C01571 implements com.google.android.gms.internal.zzja.zza {
        final /* synthetic */ zzd zzBv;

        C01571(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    private class zzd extends zzhz {
        ...
        class C01581 implements Runnable {
            ...
            C01581(zzd com_google_android_gms_ads_internal_overlay_zzd_zzd, Drawable drawable) {
        ...
        public void zzbn() {
            ...
            if (zzg != null) {
                zzid.zzIE.post(new C01581(this, zzp.zzbx().zza(this.zzBv.mActivity, zzg, this.zzBv.zzBi.zzBM.zzpw, this.zzBv.zzBi.zzBM.zzpx)));
            }
        }
    }
    ...
    protected void zzv(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzoM.zzhe().zza(new C01571(this));
