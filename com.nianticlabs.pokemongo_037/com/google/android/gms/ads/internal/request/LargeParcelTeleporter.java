...
public final class LargeParcelTeleporter implements SafeParcelable {
    ...
    class C01611 implements Runnable {
        ...
        C01611(LargeParcelTeleporter largeParcelTeleporter, OutputStream outputStream, byte[] bArr) {
    ...
    public <T extends SafeParcelable> T zza(Creator<T> creator) {
        if (this.zzFe) {
            if (this.zzFc == null) {
                zzb.m40e("File descriptor is empty, returning null.");
                return null;
            }
    ...
    protected <T> ParcelFileDescriptor zzf(byte[] bArr) {
        ...
        try {
            ...
            try {
                new Thread(new C01611(this, autoCloseOutputStream, bArr)).start();
                return createPipe[0];
            } catch (IOException e2) {
                e = e2;
            }
