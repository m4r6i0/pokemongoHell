...
public class zzf extends zzc {
    ...
    class C01741 implements zzb {
        final /* synthetic */ zzhs zzoO;
        final /* synthetic */ zzf zzoP;

        C01741(zzf com_google_android_gms_ads_internal_zzf, zzhs com_google_android_gms_internal_zzhs) {
            ...
            if (this.zzot.zzbN()) {
                if (com_google_android_gms_internal_zzhs2.zzBD != null) {
                    ...
                    if (com_google_android_gms_internal_zzhs2.zzbY()) {
                        ...
                        com_google_android_gms_internal_zzhs2.zzBD.zzhe().zza(new C01741(this, com_google_android_gms_internal_zzhs2));
                    }
                }
