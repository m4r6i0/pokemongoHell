...
public class zzj extends zza implements OnClickListener, OnTouchListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C01491 implements Runnable {
        ...
        C01491(zzj com_google_android_gms_ads_internal_formats_zzj, zzh com_google_android_gms_ads_internal_formats_zzh) {
    ...
    public void zzb(zzd com_google_android_gms_dynamic_zzd) {
        synchronized (this.zzpd) {
            ...
            zzid.zzIE.post(new C01491(this, com_google_android_gms_ads_internal_formats_zzh));
