...
public class zzh {
    ...
    class C01441 implements zzdk {
        final /* synthetic */ zzh zzwO;

        /* renamed from: com.google.android.gms.ads.internal.formats.zzh.1.1 */
        class C01431 implements com.google.android.gms.internal.zzja.zza {
            final /* synthetic */ Map zzwP;
            final /* synthetic */ C01441 zzwQ;

            C01431(C01441 c01441, Map map) {
                this.zzwQ = c01441;
                this.zzwP = map;
            }
        ...
        C01441(zzh com_google_android_gms_ads_internal_formats_zzh) {
        ...
        public void zza(zziz com_google_android_gms_internal_zziz, Map<String, String> map) {
            this.zzwO.zzoM.zzhe().zza(new C01431(this, map));
    ...
    class C01452 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01452(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01463 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01463(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01474 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01474(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    class C01485 implements zzdk {
        final /* synthetic */ zzh zzwO;

        C01485(zzh com_google_android_gms_ads_internal_formats_zzh) {
            this.zzwO = com_google_android_gms_ads_internal_formats_zzh;
        }
    ...
    public zziz zzdC() {
        ...
        this.zzwJ.zza("/loadHtml", new C01441(this));
        this.zzwJ.zza("/showOverlay", new C01452(this));
        this.zzwJ.zza("/hideOverlay", new C01463(this));
        this.zzoM.zzhe().zza("/hideOverlay", new C01474(this));
        this.zzoM.zzhe().zza("/sendMessageToSdk", new C01485(this));
        return this.zzoM;
    }
