...
public abstract class zzc extends zzb implements zzg, zzfi {
    ...
    class C01701 implements Runnable {
        ...
        C01701(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza) {
    ...
    class C01732 implements Runnable {
        ...
        class C01711 implements OnTouchListener {
            final /* synthetic */ zze zzoE;
            final /* synthetic */ C01732 zzoF;

            C01711(C01732 c01732, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = c01732;
        ...
        class C01722 implements OnClickListener {
            ...
            C01722(C01732 c01732, zze com_google_android_gms_ads_internal_zze) {
                this.zzoF = c01732;
                this.zzoE = com_google_android_gms_ads_internal_zze;
            }
        ...
        C01732(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
            this.zzoC = com_google_android_gms_ads_internal_zzc;
            this.zzoB = com_google_android_gms_internal_zzhs_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C01711(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C01722(this, com_google_android_gms_ads_internal_zze));
    ...
    protected void zza(zza com_google_android_gms_internal_zzhs_zza, zzcg com_google_android_gms_internal_zzcg) {
        if (com_google_android_gms_internal_zzhs_zza.errorCode != -2) {
            zzid.zzIE.post(new C01701(this, com_google_android_gms_internal_zzhs_zza));
            return;
        }
        ...
        zzid.zzIE.post(new C01732(this, com_google_android_gms_internal_zzhs_zza, com_google_android_gms_internal_zzcg));
    }
