...
public final class Gson {
    ...
    class C06581 implements JsonDeserializationContext {
        C06581() {
        }
    ...
    class C06592 implements JsonSerializationContext {
        C06592() {
        }
    ...
    class C06603 extends TypeAdapter<Number> {
        C06603() {
        }
    ...
    class C06614 extends TypeAdapter<Number> {
        C06614() {
        }
    ...
    static class C06625 extends TypeAdapter<Number> {
        C06625() {
        }
    ...
    static class C06636 extends TypeAdapter<AtomicLong> {
        final /* synthetic */ TypeAdapter val$longAdapter;

        C06636(TypeAdapter typeAdapter) {
    ...
    static class C06647 extends TypeAdapter<AtomicLongArray> {
        final /* synthetic */ TypeAdapter val$longAdapter;

        C06647(TypeAdapter typeAdapter) {
            this.val$longAdapter = typeAdapter;
        }
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingPolicy, Map<Type, InstanceCreator<?>> instanceCreators, boolean serializeNulls, boolean complexMapKeySerialization, boolean generateNonExecutableGson, boolean htmlSafe, boolean prettyPrinting, boolean lenient, boolean serializeSpecialFloatingPointValues, LongSerializationPolicy longSerializationPolicy, List<TypeAdapterFactory> typeAdapterFactories) {
        ...
        this.deserializationContext = new C06581();
        this.serializationContext = new C06592();
