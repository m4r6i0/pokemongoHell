...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    class C06941 extends BoundField {
        ...
        C06941(String name, boolean serialized, boolean deserialized, Gson gson, Field field, TypeToken typeToken, boolean z) {
    ...
    private BoundField createBoundField(Gson context, Field field, String name, TypeToken<?> fieldType, boolean serialize, boolean deserialize) {
        return new C06941(name, serialize, deserialize, context, field, fieldType, Primitives.isPrimitive(fieldType.getRawType()));
    }
