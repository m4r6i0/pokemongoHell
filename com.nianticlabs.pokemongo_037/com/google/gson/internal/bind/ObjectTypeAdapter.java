...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    ...
    static class C06921 implements TypeAdapterFactory {
        C06921() {
        }
    ...
    public Object read(JsonReader in) throws IOException {
        switch (C06932.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
