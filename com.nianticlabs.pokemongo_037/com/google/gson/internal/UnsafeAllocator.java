...
public abstract class UnsafeAllocator {
    ...
    static class C06841 extends UnsafeAllocator {
        final /* synthetic */ Method val$allocateInstance;
        final /* synthetic */ Object val$unsafe;

        C06841(Method method, Object obj) {
    ...
    static class C06852 extends UnsafeAllocator {
        final /* synthetic */ int val$constructorId;
        final /* synthetic */ Method val$newInstance;

        C06852(Method method, int i) {
    ...
    static class C06863 extends UnsafeAllocator {
        final /* synthetic */ Method val$newInstance;

        C06863(Method method) {
            this.val$newInstance = method;
        }
    ...
    static class C06874 extends UnsafeAllocator {
        C06874() {
        }
    ...
    public static UnsafeAllocator create() {
        try {
            ...
            return new C06841(unsafeClass.getMethod("allocateInstance", new Class[]{Class.class}), f.get(null));
        } catch (Exception e) {
            Method newInstance;
            try {
